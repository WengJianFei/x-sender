!function (t, e) {
    ...
    "use strict";
    var t, e, i, s, n, a, o, c, h, r, l, d, p, g, f, u, m, x, y, w, E, v, b, k, C, N, O, D, T, S, L, $, M, A, W, I, R,
        B, P, H, K, z, _, F, Y, j, V, G, U, Z, q, X, J, Q, tt, et, it, st = Object.defineProperty, nt = t => {
            throw TypeError(t)
    ...
    const pt = '<div class="ant-spin ant-spin-spinning" aria-live="polite" aria-busy="true"><span class="ant-spin-dot ant-spin-dot-spin"><i class="ant-spin-dot-item"></i><i class="ant-spin-dot-item"></i><i class="ant-spin-dot-item"></i><i class="ant-spin-dot-item"></i></span></div>',
        ...
        bt = "richMention", kt = "richTrigger", Ct = "richSelect", Nt = "richInput", Ot = "richCustom",
    ...
    class zt {
        ...
        async asyncMatchDialog(t = "") {
            ...
            if (e === this.matchKey) {
                ...
                Ht(s, !0, "flex"), t.scrollTop = 0, Ht(e, 0 === this.options.length, "flex"), Ht(s, !1), this.switchActiveMention(t.children[0]), this.moveDialog()
            }
        }
    ...
    t = new WeakMap, e = new WeakSet, i = function () {
        ...
        this.bus.on(t, "closeDialog", () => {
            this.closeDialog()
        }), this.bus.on(t, "moveActiveMention", $t(this.moveActiveMention, 120).bind(this)), this.bus.on(t, "matchDialog", Lt(this.matchDialog, 200).bind(this)), this.bus.on(t, "updateDialogReact", Lt(() => {
            Kt(this.dialog) && this.moveDialog()
        ...
        rt(this, t, [[this.chatElement.richText, {
            ...
            click: () => {
                ...
                !this.chatElement.chat.chatEditor.isComposition && Kt(this.dialog) && Rt(t, "dialog-options") && (t.preventDefault(), "ArrowUp" === t.key || "ArrowUp" === t.code ? this.bus.emit("moveActiveMention", "up") : "ArrowDown" === t.key || "ArrowDown" === t.code ? this.bus.emit("moveActiveMention", "down") : "Enter" !== t.key && "Enter" !== t.code && "NumpadEnter" !== t.code || this.activeMention && this.activeMention.click())
            }
        }]]), ct(this, t).forEach(t => {
            const e = t[0], i = t[1];
    ...
    a = new WeakMap, o = new WeakSet, c = function () {
        ...
        this.bus.on(t, "closeDialog", () => {
            this.closeDialog()
        }), this.bus.on(t, "moveActiveTrigger", $t(this.moveActiveTrigger, 120).bind(this)), this.bus.on(t, "matchDialog", Lt(this.matchDialog, 200).bind(this)), this.bus.on(t, "updateDialogReact", Lt(() => {
            Kt(this.dialog) && this.moveDialog()
        }, 200)), this.bus.on(t, "destroy", () => {
            this.destroy()
        })
        ...
        rt(this, a, [[this.chatElement.richText, {
            ...
            click: () => {
                ...
                !this.chatElement.chat.chatEditor.isComposition && Kt(this.dialog) && Rt(t, "dialog-options") && (t.preventDefault(), "ArrowUp" === t.key || "ArrowUp" === t.code ? this.bus.emit("moveActiveTrigger", "up") : "ArrowDown" === t.key || "ArrowDown" === t.code ? this.bus.emit("moveActiveTrigger", "down") : "Enter" !== t.key && "Enter" !== t.code && "NumpadEnter" !== t.code || this.activeTrigger && this.activeTrigger.click())
            }
        }]]), ct(this, a).forEach(t => {
            const e = t[0], i = t[1];
            for (const s in i) e.addEventListener(s, i[s])
    ...
    class jt {
        constructor(t, e) {
            ht(this, v), at(this, "chat"), at(this, "container"), at(this, "rollBox"), at(this, "richText"), at(this, "placeholder"), at(this, "dialogRoot"), at(this, "mentionDialog"), at(this, "triggerDialogs"), at(this, "selectDialogs"), at(this, "beforeTip"), this.chat = e, this.container = t, this.rollBox = document.createElement("div"), this.richText = document.createElement("div"), this.placeholder = document.createElement("div"), this.dialogRoot = document.createElement("div"), lt(this, v, b).call(this), lt(this, v, k).call(this), lt(this, v, C).call(this), lt(this, v, N).call(this)
        }
    ...
    class ee {
        ...
        async fixEditor(t) {
            this.$el.innerHTML = "", t || (t = this.compileNodes(this.NODES)), this.NODES = t.map(t => new te(this, t)), this.focusLast(), await lt(this, I, V).call(this)
        }
        ...
        findNode(t, e = 5, i = !0) {
            ...
            if (n === bt || n === kt || n === Ct || n === Nt || n === Ot || n === Dt) {
                const t = s, e = t.parentElement, i = Array.prototype.indexOf.call(e.children, t),
                    n = Array.prototype.indexOf.call(this.$el.children, e);
                return this.NODES[n].children[i]
            }
        ...
        async insertNodes(t) {
            ...
            }), c && c.mergeNode(), h ? h.mergeNode(!0) : n.mergeNode(!0), await lt(this, I, V).call(this)
        }
        ...
        async insertInputText(t) {
            ...
            s.setText(i, n), await lt(this, I, V).call(this)
        }
        ...
        async insertMention(t) {
            ...
            n.children.splice(i + 1, 0, a), await lt(this, I, V).call(this)
        }
        ...
        async insertInput(t) {
            ...
            n.children.splice(i + 1, 0, a), a.focus(-1), await lt(this, I, V).call(this)
        }
        ...
        async insertComponent(t, e) {
            ...
            o.children.splice(n + 1, 0, c), await lt(this, I, V).call(this)
        }
    }
    ...
    A = new WeakMap, W = new WeakMap, I = new WeakSet, R = function () {
        ...
        rt(this, W, [[this.$el, {
            keydown: t => {
                if (this.isComposition = t.isComposing, this.chat.deviceInfo.isPc || !Rt(t, "IME")) {
                    if (!this.IME_MODEL) if (this.isComposition || !Rt(t, "text-backspace") && !Rt(t, "text-delete")) this.chat.options.keyboardWrapFun(t) || !this.chat.deviceInfo.isPc && "Enter" === t.key ? (t.preventDefault(), t.stopPropagation(), lt(this, I, H).call(this)) : !ct(this, A) && this.chat.options.keyboardSendFun(t) ? (t.preventDefault(), t.stopPropagation(), this.isComposition || this.bus.emit("send")) : Rt(t, "text-select-all") ? (t.preventDefault(), t.stopPropagation(), this.selectAll()) : Rt(t, "text-move") ? (t.preventDefault(), t.stopPropagation(), this.isComposition || this.cursorMove("ArrowLeft" === t.key || "ArrowLeft" === t.code ? -1 : 1)) : Rt(t, "text-undo") ? (t.preventDefault(), t.stopPropagation(), lt(this, I, F).call(this)) : Rt(t, "text-redo") ? (t.preventDefault(), t.stopPropagation(), lt(this, I, Y).call(this)) : Rt(t, "text-jump") && (t.preventDefault(), t.stopPropagation(), t.shiftKey ? this.chat.jumpPrev() : this.chat.jumpNext()); else {
        ...
        const C = u.children.indexOf(x),
            N = this.compileNodes([{type: "Gird", children: u.children.filter((t, e) => e < C)}]);
        ...
        O.unshift(k[0]), O.push(N[0]), i.setData(Tt, JSON.stringify(O))
    }, z = async function (t) {
    ...
    class se {
        constructor(t, e) {
            ...
            this.bus = new ie, this.chatElement = new jt(t, this), this.chatEditor = new ee(this), this.updateConfig(e)
        }
    ...
    return at(se, "version", "1.2.4"), at(se, "Component", class extends Ut {
        constructor(t) {
            var e;
