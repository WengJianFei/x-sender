!function (t, e) {
    ...
    "use strict";
    var t, e, i, s, n, a, o, c, h, r, l, d, p, g, f, u, m, x, y, E, w, v, b, N, k, O, C, T, D, S, L, M, I, A, $, R, W,
        _, K, P, B, H, V, z, Y, F, j, G, U, X, Z, q, J, Q, tt, et, it, st = Object.defineProperty, nt = t => {
            throw TypeError(t)
        }, at = (t, e, i) => ((t, e, i) => e in t ? st(t, e, {
            enumerable: !0,
            configurable: !0,
            writable: !0,
            value: i
        }) : t[e] = i)(t, "symbol" != typeof e ? e + "" : e, i), ot = (t, e, i) => e.has(t) || nt("Cannot " + i),
        ct = (t, e, i) => (ot(t, e, "read from private field"), i ? i.call(t) : e.get(t)),
        ht = (t, e, i) => e.has(t) ? nt("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, i),
    ...
    const pt = '<div class="ant-spin ant-spin-spinning" aria-live="polite" aria-busy="true"><span class="ant-spin-dot ant-spin-dot-spin"><i class="ant-spin-dot-item"></i><i class="ant-spin-dot-item"></i><i class="ant-spin-dot-item"></i><i class="ant-spin-dot-item"></i></span></div>',
        ...
        ft = {
            ...
            placeholder: "",
            maxLength: -1,
            keyboardWrapFun: t => (t.ctrlKey || t.shiftKey) && ["Enter"].includes(t.key),
            keyboardSendFun: t => !t.ctrlKey && !t.shiftKey && ["Enter"].includes(t.key)
        }, ut = {
            dialogTitle: "群成员",
            callEvery: !0,
            everyText: "所有人",
            ...
            offsetTop: 0
        }, yt = Symbol("EVENT_COMMON_SEND"), Et = Symbol("EVENT_COMMON_CHANGE"), wt = Symbol("EVENT_COMMON_DESTROY"),
        vt = Symbol("EVENT_COMMON_TIP_STATE"), bt = Symbol("EVENT_COMMON_DIALOG_CLOSE"),
        Nt = Symbol("EVENT_COMMON_SELECT_ACTIVE"), kt = Symbol("EVENT_EDITOR_CHANGE"),
        Ot = Symbol("EVENT_EDITOR_DELETE"), Ct = Symbol("EVENT_EDITOR_CURSOR_CHANGE"),
        Tt = Symbol("EVENT_EDITOR_LINE_BREAK"), Dt = Symbol("EVENT_EDITOR_UNDO"), St = Symbol("EVENT_EDITOR_REDO"),
        Lt = Symbol("EVENT_EDITOR_HISTORY"), Mt = Symbol("EVENT_EDITOR_MAXLENGTH"),
        It = Symbol("EVENT_EDITOR_SWITCH_DISABLED"), At = Symbol("EVENT_EDITOR_INSERT_MENTION"),
        $t = Symbol("EVENT_EDITOR_INSERT_TRIGGER"), Rt = Symbol("EVENT_EDITOR_INSERT_SELECT"),
        Wt = Symbol("EVENT_EDITOR_INSERT_INPUT"), _t = Symbol("EVENT_EDITOR_INSERT_CUSTOM"),
        Kt = Symbol("EVENT_EDITOR_FOCUS"), Pt = Symbol("EVENT_TIP_OPEN"), Bt = Symbol("EVENT_TIP_CLOSE"),
        Ht = Symbol("EVENT_DIALOG_MATCH"), Vt = Symbol("EVENT_DIALOG_UPDATE_REACT"),
        zt = Symbol("EVENT_DIALOG_KEYBOARD_MOVE"), Yt = "data-set-empty", Ft = "data-set-richType", jt = "richGrid",
        Gt = "richMark", Ut = "richWrite", Xt = "richMention", Zt = "richTrigger", qt = "richSelect", Jt = "richInput",
        Qt = "richCustom", te = "richComponent", ee = "application/chat-nodes", ie = "\ufeff", se = (t, e, i = !1) => {
            let s;
            return function (...n) {
                const a = this, o = i && !s;
        ...
        he = (t, e, i = !1) => i ? oe(t[e]) ? t[e + 1] && ce(t[e + 1]) ? t[e - 1] && "‍" === t[e - 1] && t[e - 2] && t[e - 3] && ce(t[e - 2]) && oe(t[e - 3]) ? [3, 2] : t[e + 2] && "‍" === t[e + 2] && t[e + 3] && t[e + 4] && oe(t[e + 3]) && ce(t[e + 4]) ? [0, 5] : [0, 2] : [0, 0] : ce(t[e]) ? t[e - 1] && oe(t[e - 1]) ? t[e - 2] && "‍" === t[e - 2] && t[e - 3] && t[e - 4] && ce(t[e - 3]) && oe(t[e - 4]) ? [4, 1] : t[e + 1] && "‍" === t[e + 1] && t[e + 2] && t[e + 3] && oe(t[e + 2]) && ce(t[e + 3]) ? [1, 4] : [1, 1] : [0, 0] : "‍" === t[e] && t[e - 1] && t[e - 2] && ce(t[e - 1]) && oe(t[e - 2]) && t[e + 1] && t[e + 2] && oe(t[e + 1]) && ce(t[e + 2]) ? [2, 3] : [0, 0] : ce(t[e]) ? t[e - 1] && oe(t[e - 1]) ? t[e + 1] && "‍" === t[e + 1] && t[e + 2] && t[e + 3] && oe(t[e + 2]) && ce(t[e + 3]) ? [2, 3] : t[e - 2] && "‍" === t[e - 2] && t[e - 3] && t[e - 4] && ce(t[e - 3]) && oe(t[e - 4]) ? [5, 0] : [2, 0] : [0, 0] : oe(t[e]) ? t[e + 1] && ce(t[e + 1]) ? t[e + 2] && "‍" === t[e + 2] && t[e + 3] && t[e + 4] && oe(t[e + 3]) && ce(t[e + 4]) ? [1, 4] : t[e - 1] && "‍" === t[e - 1] && t[e - 2] && t[e - 3] && ce(t[e - 2]) && oe(t[e - 3]) ? [4, 1] : [1, 1] : [0, 0] : "‍" === t[e] && t[e - 1] && t[e - 2] && ce(t[e - 1]) && oe(t[e - 2]) && t[e + 1] && t[e + 2] && oe(t[e + 1]) && ce(t[e + 2]) ? [3, 2] : [0, 0],
        re = (t, e) => t.replace(/{{(\w+)}}/g, (t, i) => void 0 !== e[i] ? e[i] : t);
    ...
    function pe(t, e) {
        switch (e) {
            ...
            case"text-updown":
                return "ArrowUp" === t.key || "ArrowDown" === t.key || "ArrowUp" === t.code || "ArrowDown" === t.code;
        ...
        for (let r = 0; r <= o; r++) for (let t = 0; t <= c; t++) if (h[r][t] && t < c) {
            ...
            for (let i = r; i < o; i++) {
                ...
                if ("char" === e.type) s.char === e.value && (h[i + 1][t + 1] = !0); else {
                    ...
                    if (r === c) h[i + 1][t + 1] = !0; else if (r === a) h[i + 1][t + 1] = !0; else if (fe(r, a)) h[i + 1][t + 1] = !0; else for (let e = 2; e <= o - i; e++) {
    ...
    class xe {
        constructor(a, o) {
            ht(this, e), at(this, "eventKey", Symbol("MentionDialog")), at(this, "chatElement"), at(this, "bus"), at(this, "dialog"), at(this, "activeMention", null), at(this, "title", ""), at(this, "callEvery", !0), at(this, "everyText", ""), at(this, "emptyText", ""), at(this, "options", []), at(this, "asyncMatch"), at(this, "matchKey", 0), ht(this, t, []), this.dialog = document.createElement("div"), this.chatElement = a, this.bus = this.chatElement.chat.bus, lt(this, e, i).call(this), lt(this, e, s).call(this), lt(this, e, n).call(this), this.updateConfig(o)
        }
        ...
        getRenderMention(t) {
            ...
            e.setAttribute("data-id", t.id), e.setAttribute("data-name", t.name), e.classList.add("chat-mention-dialog-item"), ue(e, !0, "flex");
        ...
        openDialog(t) {
            if (me(this.dialog) || this.bus.emit(bt), this.asyncMatch) {
                this.options = [], this.updateRender();
                const t = this.dialog.children[2], e = this.dialog.children[3];
                ue(t, !1), ue(e, !0, "flex"), ue(this.dialog), this.moveDialog(), this.bus.emit(It, !0)
                ...
                Array.from(e.children, t => {
                    ...
                    s.includes(e) ? (ue(t, !0, "flex"), i || (i = t)) : ue(t, !1)
                }), this.switchActiveMention(i || e.children[0]), ue(this.dialog), this.moveDialog(), this.bus.emit(It, !0)
            }
        }

        closeDialog() {
            me(this.dialog) && (ue(this.dialog, !1), this.switchActiveMention(), this.bus.emit(It, !1))
        }
        ...
        pinyinMatchDialog(t) {
            return t ? this.options.filter(e => ge(e.name, e.pinyin || "", t)) : this.callEvery ? [{
                id: "ALL",
                name: this.everyText
        ...
        async asyncMatchDialog(t = "") {
            ...
            if (e === this.matchKey) {
                ...
                ue(s, !0, "flex"), t.scrollTop = 0, ue(e, 0 === this.options.length, "flex"), ue(s, !1), this.switchActiveMention(t.children[0]), this.moveDialog()
            }
        }

        destroy() {
            this.bus.offKeyEvent(this.eventKey), this.dialog.parentElement && this.dialog.parentElement.removeChild(this.dialog), ct(this, t).forEach(t => {
                const e = t[0], i = t[1];
    ...
    t = new WeakMap, e = new WeakSet, i = function () {
        this.bus.on(this.eventKey, bt, () => {
            this.closeDialog()
        }), this.bus.on(this.eventKey, zt, ne(this.moveActiveMention, 120).bind(this)), this.bus.on(this.eventKey, Ht, se(this.matchDialog, 200).bind(this)), this.bus.on(this.eventKey, Vt, se(() => {
            me(this.dialog) && this.moveDialog()
        }, 200)), this.bus.on(this.eventKey, wt, () => {
            this.destroy()
        })
    }, s = function () {
        rt(this, t, [[this.chatElement.richText, {
            keydown: t => {
                me(this.dialog) && (pe(t, "dialog-options") ? t.preventDefault() : pe(t, "text-move") && this.closeDialog())
            }, keyup: t => {
                if (t.stopPropagation(), "@" === t.key || "2" === String(t.key) || pe(t, "IME")) {
            ...
            mousedown: () => {
                ...
                !this.chatElement.chat.chatEditor.isComposition && me(this.dialog) && pe(t, "dialog-options") && (t.preventDefault(), "ArrowUp" === t.key || "ArrowUp" === t.code ? this.bus.emit(zt, "up") : "ArrowDown" === t.key || "ArrowDown" === t.code ? this.bus.emit(zt, "down") : "Enter" !== t.key && "Enter" !== t.code && "NumpadEnter" !== t.code || this.activeMention && this.activeMention.click())
            }
        }]]), ct(this, t).forEach(t => {
            const e = t[0], i = t[1];
        ...
        const s = document.createElement("div");
        s.classList.add("chat-mention-dialog-empty"), ue(s, !1), t.appendChild(s);
        const n = document.createElement("div");
        n.classList.add("chat-mention-dialog-loading"), n.innerHTML = pt, ue(n, !1), t.appendChild(n), this.dialog.appendChild(t), this.chatElement.dialogRoot.appendChild(this.dialog)
    };

    class ye {
        constructor(t, e) {
            ht(this, o), at(this, "eventKey", ""), at(this, "bus"), at(this, "chatElement"), at(this, "dialog"), at(this, "activeTrigger", null), at(this, "title"), at(this, "key"), at(this, "options"), at(this, "keyMap"), ht(this, a, []), this.title = e.dialogTitle, this.key = e.key, this.options = e.options, this.keyMap = e.keyMap, this.dialog = document.createElement("div"), this.chatElement = t, this.bus = this.chatElement.chat.bus, lt(this, o, c).call(this), lt(this, o, h).call(this), lt(this, o, r).call(this)
        }

        openDialog(t) {
            if (me(this.dialog) || this.bus.emit(bt), this.options.length > 0) {
                const e = this.dialog.children[1];
                let i;
                e.scrollTop = 0;
                const s = (t || this.pinyinMatchDialog()).map(t => t.id);
                Array.from(e.children, t => {
                    const e = t.getAttribute("data-id");
                    s.includes(e) ? (ue(t, !0, "flex"), i || (i = t)) : ue(t, !1)
                }), this.switchActiveTrigger(i || e.children[0]), ue(this.dialog), this.moveDialog(), this.bus.emit(It, !0)
            }
        }

        closeDialog() {
            me(this.dialog) && (ue(this.dialog, !1), this.switchActiveTrigger(), this.bus.emit(It, !1))
        }
        ...
        pinyinMatchDialog(t) {
            return t ? this.options.filter(e => ge(e.name, e.pinyin || "", t)) : this.options
        }

        destroy() {
            this.bus.offKeyEvent(this.eventKey), this.dialog.parentElement && this.dialog.parentElement.removeChild(this.dialog), ct(this, a).forEach(t => {
                const e = t[0], i = t[1];
                for (const s in i) e.removeEventListener(s, i[s])
            })
        }
    ...
    a = new WeakMap, o = new WeakSet, c = function () {
        this.eventKey = Symbol("TriggerDialog-" + this.key), this.bus.on(this.eventKey, bt, () => {
            this.closeDialog()
        }), this.bus.on(this.eventKey, zt, ne(this.moveActiveTrigger, 120).bind(this)), this.bus.on(this.eventKey, Ht, se(this.matchDialog, 200).bind(this)), this.bus.on(this.eventKey, Vt, se(() => {
            me(this.dialog) && this.moveDialog()
        }, 200)), this.bus.on(this.eventKey, wt, () => {
            this.destroy()
        })
    }, h = function () {
        rt(this, a, [[this.chatElement.richText, {
            keydown: t => {
                me(this.dialog) && (pe(t, "dialog-options") ? t.preventDefault() : pe(t, "text-move") && this.closeDialog())
            }, keyup: t => {
                if (t.stopPropagation(), this.keyMap.includes(String(t.key)) || pe(t, "IME")) {
                    const t = this.chatElement.chat.getSelection(), e = t.focusNode,
                        i = this.chatElement.chat.chatEditor.findNode(e);
                    if (i && "Write" === i.type) {
                        const e = t.focusOffset;
            ...
            mousedown: () => {
                ...
                !this.chatElement.chat.chatEditor.isComposition && me(this.dialog) && pe(t, "dialog-options") && (t.preventDefault(), "ArrowUp" === t.key || "ArrowUp" === t.code ? this.bus.emit(zt, "up") : "ArrowDown" === t.key || "ArrowDown" === t.code ? this.bus.emit(zt, "down") : "Enter" !== t.key && "Enter" !== t.code && "NumpadEnter" !== t.code || this.activeTrigger && this.activeTrigger.click())
            }
        }]]), ct(this, a).forEach(t => {
            const e = t[0], i = t[1];
            for (const s in i) e.addEventListener(s, i[s])
        ...
        this.options.forEach(t => {
            const e = document.createElement("div");
            e.setAttribute("data-id", t.id), e.setAttribute("data-name", t.name), e.classList.add("chat-trigger-dialog-item"), ue(e, !0, "flex");
            const i = document.createElement("div");
    ...
    class Ee {
        ...
        openDialog(t) {
            ...
            if ("Select" === this.selectNode.type) {
                ...
                this.selectNode.$el.children[0].classList.add("active"), Array.from(i, e => {
                    ...
                    c && (a = e.clientHeight, n = !0), c || n || (s += e.clientHeight), ue(i, c)
                });
                const c = s - e.clientHeight / 2 + a / 2;
                e.scrollTop = n && c > 0 ? c : 0
            } else e.scrollTop = 0, Array.from(i, t => {
                ue(t, !0, "flex");
                ue(t.lastChild, !1)
            });
            this.bus.emit(It, !0), this.moveDialog()
        }

        closeDialog() {
            if (me(this.dialog)) {
                if (ue(this.dialog, !1), this.selectNode && "Select" === this.selectNode.type) {
                    this.selectNode.$el.children[0].classList.remove("active")
                }
                this.bus.emit(It, !1), this.selectNode = null
            }
        }
        ...
        destroy() {
            this.bus.offKeyEvent(this.eventKey), this.dialog.parentElement && this.dialog.parentElement.removeChild(this.dialog), ct(this, l).forEach(t => {
                const e = t[0], i = t[1];
                for (const s in i) e.removeEventListener(s, i[s])
            })
        }
    ...
    l = new WeakMap, d = new WeakSet, p = function () {
        this.eventKey = Symbol("SelectDialog-" + this.key), this.bus.on(this.eventKey, Nt, t => {
            t.key === this.key && this.chatElement.chat.nextTick(() => {
                this.openDialog(t)
            })
        }), this.bus.on(this.eventKey, bt, () => {
            this.closeDialog()
        }), this.bus.on(this.eventKey, wt, () => {
            this.destroy()
        })
    }, g = function () {
        rt(this, l, [[window, {
        ...
        if (i.textContent = this.title, e.appendChild(i), t.appendChild(e), this.showSearch) {
            ...
            i.classList.add("chat-select-dialog-search-input"), i.setAttribute("placeholder", this.placeholder), i.addEventListener("input", se(t => {
                t.stopPropagation();
                ...
                Array.from(s, t => {
                    ...
                    "" === e || -1 !== i.indexOf(e) ? (n = !1, ue(t, !0, "flex")) : ue(t, !1)
                }), ue(i, n, "flex"), this.moveDialog()
            }, 200).bind(this)), e.appendChild(i);
            const s = document.createElement("div");
            s.classList.add("chat-select-dialog-search-empty"), s.innerHTML = `${gt}<span class="empty-label">${this.searchEmptyText}</span>`, ue(s, !1), e.appendChild(s), t.appendChild(e)
        }
        const s = document.createElement("div");
        ...
        this.options.forEach(t => {
            ...
            s.classList.add("chat-select-dialog-check"), s.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="none" viewBox="0 0 24 24"><path fill="currentColor" d="M9.218 17.41 19.83 6.796a.99.99 0 1 1 1.389 1.415c-3.545 3.425-4.251 4.105-11.419 11.074a.997.997 0 0 1-1.375.018c-1.924-1.801-3.709-3.568-5.573-5.43a.999.999 0 0 1 1.414-1.413z"></path></svg>', ue(s, !1), e.appendChild(s), e.addEventListener("click", t => {
                if (t.stopPropagation(), this.selectNode && "Select" === this.selectNode.type) if (this.multiple) {
                    ...
                    const t = e.getAttribute("data-id"), i = e.getAttribute("data-name");
                    this.bus.emit(Rt, {...this.selectNode || {}, id: t, name: i}), this.closeDialog()
                }
            }), n.appendChild(e)
    ...
    class we {
        constructor(t, e) {
            ht(this, m), at(this, "eventKey", Symbol("BeforeTip")), at(this, "chatElement"), at(this, "bus"), at(this, "tip"), at(this, "dialog"), at(this, "config", {}), ht(this, u, []), this.chatElement = t, this.bus = this.chatElement.chat.bus, this.tip = document.createElement("div"), this.dialog = document.createElement("div"), lt(this, m, x).call(this), lt(this, m, y).call(this), lt(this, m, E).call(this), this.updateConfig(e)
        }
        ...
        openTip(t) {
            this.tip.innerHTML = re(this.tip.innerHTML, t), this.dialog.innerHTML = re(this.dialog.innerHTML, t), ue(this.tip);
            (this.config.closeNames || []).forEach(t => {
                ...
                ue(this.dialog), this.tip.classList.add("tip-hover");
                ...
                ue(this.dialog, !1), this.tip.classList.remove("tip-hover")
            };
            const e = this.tip.children[0].clientWidth;
            this.chatElement.container.style.setProperty("--chat-before-tip-width", `${e + Number(t.offset || 4)}px`), this.bus.emit(Kt, "mark"), lt(this, m, w).call(this), this.bus.emit(vt, !0)
        }

        closeTip() {
            me(this.tip) && (this.chatElement.container.style.setProperty("--chat-before-tip-width", "0px"), this.chatElement.container.style.setProperty("--chat-before-tip-top", "0px"), this.chatElement.container.style.setProperty("--chat-tip-dialog-left", "0px"), ue(this.tip, !1), ue(this.dialog, !1), this.tip.classList.remove("tip-hover"), this.bus.emit(Kt, "mark"), this.tip.innerHTML = this.config.tipTemplate || "", this.dialog.innerHTML = this.config.dialogTemplate || "", this.bus.emit(vt, !1))
        }

        destroy() {
            this.bus.offKeyEvent(this.eventKey), ct(this, u).forEach(t => {
                const e = t[0], i = t[1];
                for (const s in i) e.removeEventListener(s, i[s])
            })
        }
    ...
    u = new WeakMap, m = new WeakSet, x = function () {
        this.bus.on(this.eventKey, wt, () => {
            this.destroy()
        }), this.bus.on(this.eventKey, Pt, t => {
            this.openTip(t)
        }), this.bus.on(this.eventKey, Bt, () => {
            this.closeTip()
        }), this.bus.on(this.eventKey, Et, () => {
            lt(this, m, w).call(this)
        })
    }, y = function () {
        rt(this, u, [[window, {
            resize: () => {
        ...
        this.tip.classList.add("chat-before-tip-wrap"), this.dialog.classList.add("chat-tip-dialog-wrap"), this.chatElement.rollBox.appendChild(this.tip), this.chatElement.dialogRoot.appendChild(this.dialog), ue(this.tip, !1), ue(this.dialog, !1)
    }, w = function () {
        if (!me(this.tip)) return;
        ...
        this.chatElement.container.style.setProperty("--chat-before-tip-top", `${a + (this.config.offsetTop || 0)}px`)
    };

    class ve {
        constructor(t, e) {
            ht(this, v), at(this, "eventKey", Symbol("ChatElement")), at(this, "chat"), at(this, "container"), at(this, "rollBox"), at(this, "richText"), at(this, "placeholder"), at(this, "dialogRoot"), at(this, "mentionDialog"), at(this, "triggerDialogs"), at(this, "selectDialogs"), at(this, "beforeTip"), this.chat = e, this.container = t, this.rollBox = document.createElement("div"), this.richText = document.createElement("div"), this.placeholder = document.createElement("div"), this.dialogRoot = document.createElement("div"), lt(this, v, b).call(this), lt(this, v, N).call(this), lt(this, v, k).call(this), lt(this, v, O).call(this)
        }
        ...
        createMentionDialog() {
            this.mentionDialog ? this.mentionDialog.updateConfig(this.chat.options.mentionConfig) : this.mentionDialog = new xe(this, this.chat.options.mentionConfig)
        }
        ...
        createTriggerDialog() {
            this.triggerDialogs ? (this.triggerDialogs.forEach(t => {
                ...
                this.triggerDialogs.push(new ye(this, t))
            })
        }
        ...
        createSelectDialog() {
            this.selectDialogs ? (this.selectDialogs.forEach(t => {
                ...
                this.selectDialogs.push(new Ee(this, t))
            })
        }

        createBeforeTip() {
            this.beforeTip ? this.beforeTip.updateConfig(this.chat.options.tipConfig) : this.beforeTip = new we(this, this.chat.options.tipConfig)
        }

        destroy() {
            this.chat.bus.offKeyEvent(this.eventKey), this.rollBox.parentElement && this.rollBox.parentElement.removeChild(this.rollBox), this.placeholder.parentElement && this.placeholder.parentElement.removeChild(this.placeholder), this.dialogRoot.parentElement && this.dialogRoot.parentElement.removeChild(this.dialogRoot)
        }
    }

    v = new WeakSet, b = function () {
        this.chat.bus.on(this.eventKey, Et, () => {
            lt(this, v, C).call(this)
        }), this.chat.bus.on(this.eventKey, wt, () => {
            this.destroy()
        })
    }, N = function () {
        this.container.classList.add("chat-area-wrap"), this.rollBox.classList.add("chat-rich-text"), this.rollBox.classList.add("chat-scroll"), this.richText.setAttribute(Ft, "richWrap"), this.richText.setAttribute("contenteditable", "true"), this.rollBox.appendChild(this.richText), this.container.appendChild(this.rollBox)
    }, k = function () {
        this.placeholder.classList.add("chat-placeholder-wrap"), ue(this.placeholder), this.container.appendChild(this.placeholder)
    }, O = function () {
        this.dialogRoot.classList.add("chat-dialog-wrap"), this.container.appendChild(this.dialogRoot)
    }, C = function () {
        if (this.chat.chatEditor.isComposition) return ue(this.placeholder, !1);
        const t = this.chat.chatEditor.NODES;
        return t.length > 1 || t[0].children.length > 1 || t[0].children[0].text.length > 0 ? ue(this.placeholder, !1) : void ue(this.placeholder, !0)
    };

    class be {
        constructor(t) {
            at(this, "$el", null), at(this, "type", ""), this.type = t
        }
    ...
    T = new WeakSet, D = function (t, ...e) {
        this.context.context.bus.emit(t, ...e)
    };
    let Ne = class t extends be {
        constructor(t, e) {
            super(e.type), ht(this, T), at(this, "context"), at(this, "text", ""), at(this, "VOID_KEY", ie), this.context = t, this.text = String(e.text || ""), this.render(e)
        }
        ...
        focus(t) {
            ...
            i.setStart(e, t), i.setEnd(e, t), s.removeAllRanges(), s.addRange(i), lt(this, T, D).call(this, Ct, {
                node: e,
                offset: t,
                type: "Write",
                instance: this
        ...
        backspace(t) {
            ...
            if (t.isCollapsed) {
                if (0 === e || 1 === e && !Boolean(this.text)) {
                    ...
                    if (0 === t) {
                        if (0 === e) return void lt(this, T, D).call(this, Bt);
                ...
                {
                    const t = he(this.text, e - 1);
                    t[0] > 0 || t[1] > 0 ? (this.text = this.text.slice(0, e - t[0]) + this.text.slice(e + t[1]), this.syncNode(), this.focus(e - t[0])) : (this.text = this.text.slice(0, e - 1) + this.text.slice(e), this.syncNode(), this.focus(e - 1))
                }
        ...
        delete(t) {
            ...
            if (t.isCollapsed) if (e === this.text.length || 1 === e && !Boolean(this.text)) {
                ...
                const t = he(this.text, e, !0);
                t[0] > 0 || t[1] > 0 ? (this.text = this.text.slice(0, e - t[0]) + this.text.slice(e + t[1]), this.syncNode(), this.focus(e - t[0])) : (this.text = this.text.slice(0, e) + this.text.slice(e + 1), this.syncNode(), this.focus(e))
            } else {
        ...
        render(t) {
            const e = document.createElement("span");
            this.$el = e, e.setAttribute(Ft, Gt), e.classList.add("chat-write-wrap");
            const i = document.createElement("span");
            i.classList.add("chat-write-input"), i.setAttribute(Ft, Ut), i.setAttribute(Yt, String(!Boolean(this.text))), i.appendChild(document.createTextNode(Boolean(this.text) ? this.text : this.VOID_KEY)), e.appendChild(i), this.mount({
    ...
    class ke extends be {
        constructor(t, e) {
            super(t), at(this, "context"), this.context = e
        }
    ...
    class Oe extends ke {
        constructor(t, e) {
            super(e.type, t), at(this, "id", ""), at(this, "name", ""), this.id = e.id, this.name = e.name, this.render(e)
        }

        render(t) {
            const e = document.createElement("span");
            this.$el = e, e.setAttribute(Ft, Xt), e.setAttribute("contenteditable", "false"), e.classList.add("chat-tag-wrap");
            const i = document.createElement("span");
    ...
    class Ce extends ke {
        constructor(t, e) {
            super(e.type, t), at(this, "id", ""), at(this, "name", ""), at(this, "key", ""), this.id = e.id, this.name = e.name, this.key = e.key, this.render(e)
        }

        render(t) {
            const e = document.createElement("span");
            this.$el = e, e.setAttribute(Ft, Zt), e.setAttribute("contenteditable", "false"), e.classList.add("chat-tag-wrap");
            const i = document.createElement("span");
    ...
    class Te extends ke {
        constructor(t, e) {
            super(e.type, t), ht(this, S), at(this, "id", ""), at(this, "name", ""), at(this, "key", ""), this.id = e.id, this.name = e.name, this.key = e.key, this.render(e)
        }

        updateTag({id: t, name: e}) {
            this.id = t, this.name = e;
            this.$el.children[0].children[0].textContent = e, this.focus(), lt(this, S, L).call(this, kt)
        }

        render(t) {
            const e = document.createElement("span");
            this.$el = e, e.setAttribute(Ft, qt), e.setAttribute("contenteditable", "false"), e.classList.add("chat-tag-wrap");
            const i = document.createElement("span");
            ...
            i.children[0].textContent = this.name, e.appendChild(i), e.addEventListener("click", t => {
                t.stopPropagation(), this.context.context.bus.emit(Nt, this)
            }), this.mount({
                parentElm: (null == t ? void 0 : t.parentElm) || this.context.$el,
                targetElm: this.$el, ...t || {}
            })
    ...
    class De extends be {
        ...
        updateNode() {
            const t = this.$el.children[0].children[0], e = this.$el.children[0].children[1], i = t.childNodes[0],
                s = i.textContent || "";
            if (this.text = s.replace(new RegExp(`${this.WRAP_KEY[0]}|${this.VOID_KEY}`, "ig"), ""), ue(e, !Boolean(this.text), "inline-block"), Boolean(this.text)) {
        ...
        backspace(t) {
            ...
            if (t.isCollapsed) if (0 === e || 1 === e && !Boolean(this.text)) if (Boolean(this.text)) {
                ...
                const t = this.$el.children[0].children[0].childNodes[0], i = t.textContent || "", s = he(i, e - 1);
                if (s[0] > 0 || s[1] > 0) this.text = i.slice(0, e - s[0]) + i.slice(e + s[1]).replace(new RegExp(`${this.WRAP_KEY[0]}|${this.VOID_KEY}`, "ig"), ""), this.syncNode(), this.focus(e - s[0]); else {
                    const s = this.getWrapOffset(t, e, "left");
                    let n;
                    switch (s) {
                        case 1:
                            n = e - s - 2;
                    ...
                    const a = i.slice(0, n), o = i.slice(e);
        ...
        delete(t) {
            ...
            if (t.isCollapsed) if (e + s === this.fixWrapKey(this.text).length || 1 === e && !Boolean(this.text)) if (Boolean(this.text)) {
                ...
                const t = i.textContent || "", n = he(t, e, !0);
                if (n[0] > 0 || n[1] > 0) this.text = t.slice(0, e - n[0]) + t.slice(e + n[1]).replace(new RegExp(`${this.WRAP_KEY[0]}|${this.VOID_KEY}`, "ig"), ""), this.syncNode(), this.focus(e - n[0]); else {
                    let i, n, a;
                    switch (s) {
                        case 1:
                            i = 2, n = 1, a = e + 1;
                    ...
                    const o = t.slice(0, e - i), c = t.slice(e + n);
                    this.text = (o + c).replace(new RegExp(`${this.WRAP_KEY[0]}|${this.VOID_KEY}`, "ig"), ""), this.syncNode(), this.focus(a)
                }
            } else this.deleteRangeNode({
                anchorInstance: this,
                anchorOffset: e,
        ...
        focus(t) {
            ...
            t || 0 === t ? -1 === t && (t = e.textContent === this.VOID_KEY ? 1 : e.textContent.length) : t = e.textContent === this.VOID_KEY ? 1 : 0;
            const i = new Range, s = this.context.context.chat.getSelection();
            i.setStart(e, t), i.setEnd(e, t), s.removeAllRanges(), s.addRange(i), lt(this, M, I).call(this, Ct, {
                node: e,
                offset: t,
                type: "Input",
                instance: this
        ...
        render(t) {
            const e = document.createElement("span");
            this.$el = e, e.setAttribute(Ft, Jt), e.setAttribute("contenteditable", "false"), e.classList.add("chat-tag-wrap");
            const i = document.createElement("span");
            ...
            n.classList.add("input-tip"), n.textContent = `[${this.placeholder}]`, i.appendChild(n), Boolean(this.text) && ue(n, !1), e.addEventListener("click", () => {
    ...
    M = new WeakSet, I = function (t, ...e) {
        this.context.context.bus.emit(t, ...e)
    };

    class Se extends ke {
        constructor(t, e) {
            super(e.type, t), at(this, "html", ""), this.html = e.html, this.render(e)
        }

        render(t) {
            const e = document.createElement("span");
            this.$el = e, e.setAttribute(Ft, Qt), e.setAttribute("contenteditable", "false"), e.classList.add("chat-tag-wrap"), e.innerHTML = this.html, this.mount({
                parentElm: (null == t ? void 0 : t.parentElm) || this.context.$el,
                targetElm: this.$el, ...t || {}
            })
        }
    ...
    class Le extends be {
        constructor(t, e, i) {
            super("Grid"), at(this, "children", []), at(this, "context"), this.context = t, this.render(e, i)
        }
        ...
        splitNode(t, e = 0) {
            ...
            this.children = o;
            const h = new Le(this.context, [], {afterElm: this.$el});
        ...
        splitWriteNode(t, e) {
            ...
            t.text = s, t.syncNode();
            const a = new Ne(this, {type: "Write", text: n, afterElm: t.$el});
        ...
        render(t, e) {
            ...
            this.$el = i, i.className = "chat-grid-wrap", i.setAttribute(Ft, jt), this.renderChildren(t, !1), this.mount({
        ...
        renderChildren(t, e = !0) {
            ...
            i.forEach(t => {
                ...
                switch (t.type) {
                    case"Write":
                        e = new Ne(this, {...t, parentElm: s}), this.children.push(e);
                        break;
                    case"Mention":
                        e = new Oe(this, {...t, parentElm: s}), this.children.push(e);
                        break;
                    case"Trigger":
                        e = new Ce(this, {...t, parentElm: s}), this.children.push(e);
                        break;
                    case"Select":
                        e = new Te(this, {...t, parentElm: s}), this.children.push(e);
                        break;
                    case"Input":
                        e = new De(this, {...t, parentElm: s}), this.children.push(e);
                        break;
                    case"Custom":
                        e = new Se(this, {...t, parentElm: s}), this.children.push(e);
                        break;
                    default:
            ...
            n.ruleBRTag(), e && (n.focus(-1), this.emit(kt))
        }
    }

    class Me {
        constructor(t) {
            ht(this, R), at(this, "$el"), at(this, "bus"), at(this, "chat"), at(this, "eventKey", Symbol("ChatEditor")), at(this, "isComposition", !1), at(this, "textLength", 0), ht(this, A, !1), at(this, "NODES", []), at(this, "NODE_HEIGHT", 24), at(this, "IME_MODEL", !1), at(this, "FIX_MODEL", !1), ht(this, $, []), at(this, "components", {}), at(this, "markCursorWrite", {
                node: null,
                offset: 0,
                instance: null
            }), at(this, "markCursorInput", {
                node: null,
                offset: 0,
                instance: null
            }), at(this, "markLastType", "Write"), at(this, "undoHistory", []), at(this, "redoHistory", []), at(this, "historyLoading", !1), this.chat = t, this.bus = t.bus, this.$el = t.chatElement.richText, lt(this, R, W).call(this), lt(this, R, _).call(this), this.initEditor()
        }

        initEditor() {
            this.$el.innerHTML = "", this.NODES = [new Le(this)], this.markLastType = "Write", this.NODE_HEIGHT = this.NODES[0].$el.getBoundingClientRect().height, this.undoHistory = [{
        ...
        async fixEditor(t) {
            this.$el.innerHTML = "", t || (t = this.compileNodes(this.NODES)), this.NODES = t.map(t => new Le(this, t)), this.focusLast(), await lt(this, R, j).call(this)
        }
        ...
        findNode(t, e = 5, i = !0) {
            ...
            const s = t, n = s.getAttribute ? s.getAttribute(Ft) : "";
            if (n === Ut) {
            ...
            if (n === Xt || n === Zt || n === qt || n === Jt || n === Qt || n === te) {
                const t = s, e = t.parentElement, i = Array.prototype.indexOf.call(e.children, t),
                    n = Array.prototype.indexOf.call(this.$el.children, e);
                return this.NODES[n].children[i]
            }
        ...
        cursorMove(t, e) {
            ...
            if ("Write" === a.type) {
                ...
                if (n.length >= Math.abs(t)) {
                    if (1 === Math.abs(t)) {
                        const i = !s, n = he(a.text, i ? e : e - 1, i);
                        i && n[1] > 0 ? a.focus(e + n[1]) : !i && n[0] > 0 ? a.focus(e - n[0]) : a.focus(e + t)
                    } else a.focus(e + t);
                    return void this.cursorView()
                }
                o += n.length
                ...
                if (c.length >= Math.abs(t)) {
                    if (1 === Math.abs(t)) {
                        const i = !s, o = he(n.textContent, i ? e : e - 1, i);
                        return i && o[1] > 0 ? a.focus(e + o[1]) : !i && o[0] > 0 ? a.focus(e - o[0]) : a.focus(e + t), void this.cursorView()
                    }
        ...
        async insertText(t) {
            const e = t.replace(new RegExp(`${ie}`, "ig"), "").replace(/\r\n/g, "\n").replace(/\r/g, "\n").split("\n").map(t => [{
                type: "Write",
                text: t
            }]);
        ...
        async insertNodes(t) {
            ...
            t.forEach((e, i) => {
                const s = new Le(this, e, {afterElm: o});
                o = s.$el, 0 === i ? c = s : i === t.length - 1 && (h = s), this.NODES.splice(a + i + 1, 0, s)
            }), c && c.mergeNode(), h ? h.mergeNode(!0) : n.mergeNode(!0), await lt(this, R, j).call(this)
        }

        async insertInputText(t) {
            const {instance: e, offset: i} = this.markCursorInput;
            if (!e) return;
            const s = e, n = t.replace(new RegExp(`${ie}`, "ig"), "").replace(/\r\n/g, "\n").replace(/\r/g, "\n");
            s.setText(i, n), await lt(this, R, j).call(this)
        }
        ...
        async insertMention(t) {
            ...
            const {index: i, write: s, grid: n} = e,
                a = new Oe(n, {type: "Mention", id: t.id, name: t.name, afterElm: s.$el});
            n.children.splice(i + 1, 0, a), await lt(this, R, j).call(this)
        }
        ...
        async insertTrigger(t) {
            ...
            if (!e) return;
            const {index: i, write: s, grid: n} = e,
                a = new Ce(n, {type: "Trigger", id: t.id, name: t.name, key: t.key, afterElm: s.$el});
            n.children.splice(i + 1, 0, a), await lt(this, R, j).call(this)
        }
        ...
        async insertSelect(t) {
            ...
            if (!e) return;
            const {index: i, write: s, grid: n} = e,
                a = new Te(n, {type: "Select", id: t.id, name: t.name, key: t.key, afterElm: s.$el});
            n.children.splice(i + 1, 0, a), await lt(this, R, j).call(this)
        }
        ...
        async insertInput(t) {
            ...
            if (!e) return;
            const {index: i, write: s, grid: n} = e,
                a = new De(n, {type: "Input", text: t.text, placeholder: t.placeholder, key: t.key, afterElm: s.$el});
            n.children.splice(i + 1, 0, a), a.focus(-1), await lt(this, R, j).call(this)
        }

        async insertCustom(t) {
            const e = this.splitWrite(t);
            if (!e) return;
            const {index: i, write: s, grid: n} = e, a = new Se(n, {type: "Custom", html: t.html, afterElm: s.$el});
            n.children.splice(i + 1, 0, a), await lt(this, R, j).call(this)
        }

        async reset(t) {
            if (this.$el.innerHTML = "", this.NODES = t.chatNode.map(t => new Le(this, t)), t.clearHistory) {
                const t = this.NODES[this.NODES.length - 1], e = t.children[t.children.length - 1];
                this.undoHistory = [{
                    nodes: this.compileNodes(this.NODES),
                    gridIndex: this.NODES.length - 1,
            ...
            this.markLastType = "Write", await this.chat.nextTick(), this.focusLast(), await lt(this, R, j).call(this, !t.clearHistory)
        }

        destroy() {
            this.bus.offKeyEvent(this.eventKey), ct(this, $).forEach(t => {
                const e = t[0], i = t[1];
                for (const s in i) e.removeEventListener(s, i[s])
            })
        }
        ...
        async insertComponent(t, e) {
            ...
            if (!s) return;
            const {index: n, write: a, grid: o} = s,
                c = new i({type: t, data: e, context: o, config: {afterElm: a.$el}});
            o.children.splice(n + 1, 0, c), await lt(this, R, j).call(this)
        }
    }

    A = new WeakMap, $ = new WeakMap, R = new WeakSet, W = function () {
        this.bus.on(this.eventKey, kt, async t => {
            await lt(this, R, j).call(this), t && t()
        }), this.bus.on(this.eventKey, Ot, async (t, e) => {
            await lt(this, R, K).call(this, t), e && e()
        }), this.bus.on(this.eventKey, Ct, t => {
            lt(this, R, G).call(this, t)
        }), this.bus.on(this.eventKey, Tt, async t => {
            await lt(this, R, P).call(this), t && t()
        }), this.bus.on(this.eventKey, Dt, async t => {
            await lt(this, R, z).call(this), t && t()
        }), this.bus.on(this.eventKey, St, async t => {
            await lt(this, R, Y).call(this), t && t()
        }), this.bus.on(this.eventKey, Lt, se(lt(this, R, V), 200).bind(this)), this.bus.on(this.eventKey, Mt, () => {
            lt(this, R, U).call(this)
        }), this.bus.on(this.eventKey, It, t => {
            rt(this, A, t)
        }), this.bus.on(this.eventKey, At, async (t, e) => {
            await this.insertMention(t), e && e()
        }), this.bus.on(this.eventKey, $t, async (t, e) => {
            await this.insertTrigger(t), e && e()
        }), this.bus.on(this.eventKey, Rt, async (t, e) => {
            await this.insertSelect(t), e && e()
        }), this.bus.on(this.eventKey, Wt, async (t, e) => {
            await this.insertInput(t), e && e()
        }), this.bus.on(this.eventKey, _t, async (t, e) => {
            await this.insertCustom(t), e && e()
        }), this.bus.on(this.eventKey, Kt, t => {
            switch (t) {
                case"first":
                    this.focusFirst();
                    break;
        ...
        rt(this, $, [[this.$el, {
            keydown: t => {
                if (this.isComposition = t.isComposing, this.chat.deviceInfo.isPc || !pe(t, "IME")) {
                    if (!this.IME_MODEL) if (this.isComposition || !pe(t, "text-backspace") && !pe(t, "text-delete")) if (this.chat.options.keyboardWrapFun(t) || !this.chat.deviceInfo.isPc && "Enter" === t.key) t.preventDefault(), t.stopPropagation(), lt(this, R, P).call(this); else if (!ct(this, A) && this.chat.options.keyboardSendFun(t)) t.preventDefault(), t.stopPropagation(), this.isComposition || this.bus.emit(yt); else if (pe(t, "text-select-all")) t.preventDefault(), t.stopPropagation(), this.selectAll(); else if (pe(t, "text-move")) t.preventDefault(), t.stopPropagation(), this.isComposition || this.cursorMove("ArrowLeft" === t.key || "ArrowLeft" === t.code ? -1 : 1); else if (pe(t, "text-updown")) {
                        if (!this.isComposition && !ct(this, A)) {
                            t.preventDefault(), t.stopPropagation();
                            const e = "ArrowUp" === t.key || "ArrowUp" === t.code, {
                                instance: i,
                                offset: s
                            } = this.chat.getCurrentNode();
                            if ("Write" === i.type) {
                                const t = 0 === s || "" === i.text && 1 === s,
                                    n = s === i.text.length || "" === i.text && 1 === s;
                                e ? t ? this.chat.jumpPrev("end") : i.focus(0) : n ? this.chat.jumpNext("start") : i.focus(-1)
                            } else e ? this.chat.jumpPrev("end") : this.chat.jumpNext("start")
                        }
                    } else pe(t, "text-undo") ? (t.preventDefault(), t.stopPropagation(), lt(this, R, z).call(this)) : pe(t, "text-redo") ? (t.preventDefault(), t.stopPropagation(), lt(this, R, Y).call(this)) : pe(t, "text-jump") && (t.preventDefault(), t.stopPropagation(), t.shiftKey ? this.chat.jumpPrev() : this.chat.jumpNext()); else {
                        t.preventDefault(), t.stopPropagation();
                        const e = pe(t, "text-delete");
                        lt(this, R, K).call(this, e)
                    }
                ...
                this.chat.nextTick(async () => {
                    this.$el.innerHTML = "", this.NODES = c.map(t => new Le(this, t));
                    this.NODES[a].children[o].focus(s), "insertParagraph" === t.inputType ? await lt(this, R, P).call(this) : "deleteContentBackward" === t.inputType && await lt(this, R, K).call(this), this.IME_MODEL = !1, this.FIX_MODEL = !1
                })
            }, input: () => {
                this.FIX_MODEL || (this.IME_MODEL = !1, lt(this, R, j).call(this))
            }, copy: t => {
                t.stopPropagation(), t.preventDefault(), lt(this, R, B).call(this, t)
            }, cut: t => {
                t.stopPropagation(), t.preventDefault(), lt(this, R, B).call(this, t), lt(this, R, K).call(this)
            }, paste: t => {
                t.stopPropagation(), t.preventDefault(), lt(this, R, H).call(this, t)
            }, blur: () => {
                lt(this, R, G).call(this)
            }, focus: () => {
                lt(this, R, G).call(this)
            ...
            keydown: t => {
                (pe(t, "text-undo") || pe(t, "text-redo")) && (t.preventDefault(), t.stopPropagation())
            }
        }]]);
        const t = ["blur"];
        ct(this, $).forEach(e => {
            const i = e[0], s = e[1];
            for (const n in s) i.addEventListener(n, s[n], -1 !== t.indexOf(n))
        })
    }, K = async function (t = !1) {
        ...
        if (n && a) {
            ...
            await lt(this, R, j).call(this)
        }
    }, P = async function () {
        if (this.isComposition) return;
        let t = this.chat.getSelection();
        t.isCollapsed || await lt(this, R, K).call(this), t = this.chat.getSelection();
        ...
        if (h === r) {
            ...
            return void i.setData(ee, JSON.stringify(y))
        }
        const l = n.context, d = a.context, p = this.NODES.indexOf(l), g = this.NODES.indexOf(d);
        let f, u, m, x, y, E, w, v;
        p > g ? (f = d, u = l, m = a, x = n, y = g, E = p, w = c, v = o) : (f = l, u = d, m = n, x = a, y = p, E = g, w = o, v = c);
        const b = f.children.indexOf(m),
            N = this.compileNodes([{type: "Gird", children: f.children.filter((t, e) => e > b)}]);
        "Write" === m.type ? N[0].unshift({
            type: "Write",
            text: Boolean(m.text) ? m.text.slice(w) : ""
        }) : N[0].unshift({...this.compileNodes([{type: "Gird", children: [m]}])[0][0]});
        const k = u.children.indexOf(x),
            O = this.compileNodes([{type: "Gird", children: u.children.filter((t, e) => e < k)}]);
        "Write" === x.type ? O[0].push({
            type: "Write",
            text: Boolean(x.text) ? x.text.slice(0, v) : ""
        }) : O[0].push({...this.compileNodes([{type: "Gird", children: [x]}])[0][0]});
        const C = this.compileNodes(this.NODES.slice(y + 1, E));
        C.unshift(N[0]), C.push(O[0]), i.setData(ee, JSON.stringify(C))
    }, H = async function (t) {
        const e = t.clipboardData, i = e.getData("text/plain");
        if (!i) return;
        if ("Input" === this.markLastType) return void this.insertInputText(i);
        const s = e.getData(ee) || "";
        let n = [];
        try {
            n = JSON.parse(s)
        } catch (a) {
        }
        this.chat.getSelection().isCollapsed || await lt(this, R, K).call(this), n && n.length > 0 ? this.insertNodes(n) : this.insertText(i)
    }, V = function () {
        ...
        this.redoHistory.push(t), this.undoHistory.pop(), await lt(this, R, F).call(this, e)
    }, Y = async function () {
        if (this.historyLoading || this.redoHistory.length <= 0) return;
        const t = this.redoHistory[this.redoHistory.length - 1];
        this.redoHistory.pop(), this.undoHistory.push(t), await lt(this, R, F).call(this, t)
    }, F = async function (t) {
        this.historyLoading = !0, this.$el.innerHTML = "", this.NODES = t.nodes.map(t => new Le(this, t));
        this.NODES[t.gridIndex].children[t.childIndex].focus(t.offset), await lt(this, R, j).call(this, !1), this.historyLoading = !1
    }, j = async function (t = !0) {
        const e = this.chat.getSelection(), i = e.focusNode, s = this.findNode(i);
        return s && lt(this, R, G).call(this, {
            type: s.type,
            node: s.$el.children[0].childNodes[0],
            offset: e.focusOffset,
            instance: s
        }), await this.chat.nextTick(), this.isComposition || (null == s || s.updateNode(), lt(this, R, U).call(this), this.chat.deviceInfo.isPc && t && !this.historyLoading && this.bus.emit(Lt)), s && this.cursorView(), this.bus.emit(Et), s && "Write" === s.type && this.bus.emit(this.isComposition ? Vt : Ht), !0
    }, G = function (t) {
        if (!t) {
            const e = this.chat.getSelection(), i = e.focusNode, s = this.findNode(i);
            if (!s) return;
        ...
        if (this.NODES.forEach((t, s) => {
            let n = 0;
            n = s > 0 && 1 === t.children.length && 0 === t.children[0].text.length ? 1 : t.$el.textContent.replace(new RegExp(ie, "ig"), "").length, i.push(n), e += n
        }), e > t) {
            const s = e - t;
            let n = 0, a = 0;
    ...
    class Ie {
        constructor() {
            ht(this, X), ht(this, Z), rt(this, X, Object.create(null)), rt(this, Z, Object.create(null))
        }

        on(t, e, i) {
            Reflect.get(ct(this, X), e) || Reflect.set(ct(this, X), e, Object.create(null)), Reflect.get(ct(this, Z), t) || Reflect.set(ct(this, Z), t, []), Reflect.get(ct(this, Z), t).push(e), Reflect.set(Reflect.get(ct(this, X), e), t, i)
        }

        emit(...t) {
            const e = t[0], i = t.slice(1), s = Reflect.get(ct(this, X), e);
            s && Reflect.ownKeys(s).forEach(t => {
                Reflect.get(s, t)(...i)
            })
        }

        off(t, e) {
            const i = Reflect.get(ct(this, X), e);
            Reflect.ownKeys(i).forEach(e => {
                t === e && Reflect.deleteProperty(i, e)
            }), 0 === Reflect.ownKeys(i).length && Reflect.deleteProperty(ct(this, X), e)
        }

        offKeyEvent(t) {
            (Reflect.get(ct(this, Z), t) || []).forEach(e => {
                this.off(t, e)
            }), Reflect.deleteProperty(ct(this, Z), t)
        }
    }

    X = new WeakMap, Z = new WeakMap;
    q = new WeakMap, J = new WeakSet, Q = function (t, ...e) {
        this.context.context.bus.emit(t, ...e)
    }, tt = function (t, e = "") {
        Array.from(t.children, (t, i) => {
            const s = String("" === e ? i : e + "-" + i);
            t.children && t.children.length > 0 && lt(this, J, tt).call(this, t, s);
            const n = t, a = n.dataset || {};
            if (a) {
                a.update && (ct(this, q)[s] = n, n.removeAttribute("data-update"), delete a.update);
                for (const t in a) {
                    const e = a[t];
        ...
        for (let e in ct(this, q)) {
            const i = e.split("-");
            ct(this, q)[e].innerHTML = lt(this, J, it).call(this, t, i)
        }
    }, it = function (t, e) {
    ...
    class Ae {
        constructor(t, e) {
            switch (at(this, "options"), at(this, "deviceInfo", function () {
            ...
            }()), at(this, "chatElement"), at(this, "chatEditor"), at(this, "bus"), this.options = Object.assign({}, ft, e || {}, {mentionConfig: void 0}), this.deviceInfo.isTablet && (this.deviceInfo.isPc = !1), this.options.device) {
                case"pc":
        ...
        getHtml(t) {
            ...
            return s.forEach((t, s) => {
                ...
                t.forEach((t, n) => {
                    ...
                    switch (t.type) {
                        case"Mention":
                            c += 'class="chat-tag-mention"', e.saveTagData && (c += ` data-id="${t.id}"`), c += `>@${le(t.name)}`;
                            break;
                        case"Trigger":
                            c += 'class="chat-tag-trigger"', e.saveTagData && (c += ` data-id="${t.id}" data-key=${t.key}`), c += `>${t.key}${le(t.name)}`;
                            break;
                        case"Select":
                            c += 'class="chat-tag-select"', e.saveTagData && (c += ` data-id="${t.id}" data-key=${t.key}`), c += `>${le(t.name)}`;
                            break;
                        case"Input":
                            c += 'class="chat-tag-input"', e.saveTagData && (c += ` data-placeholder="${t.placeholder}" data-key=${t.key}`), c += `>${le(t.text || t.placeholder)}`;
                            break;
                        case"Custom":
                            c += 'class="chat-tag-custom"', c += `>${t.html}`;
                            break;
                        case"Write":
                            c += 'class="chat-tag-write"', a = le(t.text), e.identifyLink ? c += `>${a.replace(i, t => `<a class="chat-tag-link" href="${t}" target="_blank">${t}</a>`)}` : c += `>${a}`;
                            break;
                        default:
                            const o = this.chatEditor.NODES[s].children[n];
        ...
        async setHtml(t) {
            return new Promise(e => {
                this.bus.emit(_t, {html: `<span style="display: inline-block;">${de(t)}</span>`}, e)
            })
        }
        ...
        async setSelect(t) {
            return new Promise(e => {
                this.bus.emit(Rt, t, e)
            })
        }

        async setInput(t) {
            return new Promise(e => {
                this.bus.emit(Wt, t, e)
            })
        }
        ...
        jumpPrev(t = "end") {
            this.bus.emit(Ct);
            const e = this.getCurrentNode().instance, i = e.context, s = i.children.indexOf(e),
                n = [...i.children.slice(0, s)].reverse().find(t => "Write" === t.type || "Input" === t.type);
            if (n) return void n.focus("start" === t ? 0 : -1);
            const a = i.context.NODES.indexOf(i);
            let o;
            [...this.chatEditor.NODES.slice(0, a)].reverse().some(t => [...t.children].reverse().some(t => {
        ...
        jumpNext(t = "end") {
            this.bus.emit(Ct);
            const e = this.getCurrentNode().instance, i = e.context, s = i.children.indexOf(e),
                n = i.children.slice(s + 1).find(t => "Write" === t.type || "Input" === t.type);
            if (n) return void n.focus("start" === t ? 0 : -1);
            const a = i.context.NODES.indexOf(i);
            let o;
            this.chatEditor.NODES.slice(a + 1).some(t => t.children.some(t => {
                if ("Write" === t.type || "Input" === t.type) return o = t, !0
        ...
        backspace(t) {
            return new Promise(e => {
                ...
                if (-1 === t || 1 === t) return void this.bus.emit(Ot, t > 0, e);
                ...
                r ? (h.setStart(o, c), h.setEnd(s, n)) : (h.setStart(s, n), h.setEnd(o, c)), a.removeAllRanges(), a.addRange(h), this.bus.emit(Ot, !r, e)
            })
        }
    ...
    return at(Ae, "version", "1.3.3"), at(Ae, "EventSet", {
        EVENT_COMMON_SEND: yt,
        EVENT_COMMON_CHANGE: Et,
        EVENT_COMMON_DESTROY: wt,
        EVENT_COMMON_TIP_STATE: vt,
        EVENT_COMMON_DIALOG_CLOSE: bt,
        EVENT_COMMON_SELECT_ACTIVE: Nt,
        EVENT_EDITOR_INSERT_MENTION: At,
        EVENT_EDITOR_INSERT_TRIGGER: $t,
        EVENT_EDITOR_INSERT_SELECT: Rt,
        EVENT_EDITOR_INSERT_INPUT: Wt,
        EVENT_EDITOR_INSERT_CUSTOM: _t
    }), at(Ae, "Component", class extends ke {
        constructor(t) {
            var e;
            super(t.type, t.context), ht(this, J), at(this, "data", {}), ht(this, q, {}), this.data = t.data || {}, this.$el = document.createElement("span"), this.$el.setAttribute(Ft, te), this.$el.setAttribute("contenteditable", "false"), this.$el.classList.add("chat-tag-wrap"), this.$el.innerHTML = this.render(), lt(this, J, tt).call(this, this.$el), this.mount({
        ...
        remove() {
            this.deleteRelevanceNode(), lt(this, J, Q).call(this, kt)
        }
