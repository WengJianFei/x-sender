!function (t, e) {
    ...
    var t, e, i, s, n, a, o, c, h, r, l, d, p, g, f, u, m, x, y, w, E, v, b, k, N, C, O, D, T, S, L, $, M, A, W, I, R,
        B, H, P, K, z, _, F, Y, V, j, G, U, Z, q, X, J, Q, tt, et, it, st = Object.defineProperty, nt = t => {
            throw TypeError(t)
    ...
    const pt = '<div class="ant-spin ant-spin-spinning" aria-live="polite" aria-busy="true"><span class="ant-spin-dot ant-spin-dot-spin"><i class="ant-spin-dot-item"></i><i class="ant-spin-dot-item"></i><i class="ant-spin-dot-item"></i><i class="ant-spin-dot-item"></i></span></div>',
        gt = {
            ...
            offsetTop: 0
        }, xt = "data-set-empty", yt = "data-set-richType", wt = "richGrid", Et = "richMark", vt = "richWrite",
        bt = "richMention", kt = "richTrigger", Nt = "richSelect", Ct = "richInput", Ot = "richCustom",
        Dt = "richComponent", Tt = "application/chat-nodes", St = "\ufeff", Lt = (t, e, i = !1) => {
            let s;
            return function (...n) {
                const a = this, o = i && !s;
        ...
        }, Mt = t => null != t, At = (t, e) => t.replace(/{{(\w+)}}/g, (t, i) => void 0 !== e[i] ? e[i] : t);
        ...
        for (let r = 0; r <= o; r++) for (let t = 0; t <= c; t++) if (h[r][t] && t < c) {
            ...
            for (let i = r; i < o; i++) {
                ...
                if ("char" === e.type) s.char === e.value && (h[i + 1][t + 1] = !0); else {
                    ...
                    if (r === c) h[i + 1][t + 1] = !0; else if (r === a) h[i + 1][t + 1] = !0; else if (Ht(r, a)) h[i + 1][t + 1] = !0; else for (let e = 2; e <= o - i; e++) {
    ...
    class zt {
        ...
        getRenderMention(t) {
            ...
            e.setAttribute("data-id", t.id), e.setAttribute("data-name", t.name), e.classList.add("chat-mention-dialog-item"), Pt(e, !0, "flex");
        ...
        openDialog(t) {
            if (Kt(this.dialog) || this.bus.emit("closeDialog"), this.asyncMatch) {
                this.options = [], this.updateRender();
                const t = this.dialog.children[2], e = this.dialog.children[3];
                Pt(t, !1), Pt(e, !0, "flex"), Pt(this.dialog), this.moveDialog(), this.bus.emit("switchDisabledState", !0)
                ...
                Array.from(e.children, t => {
                    ...
                    s.includes(e) ? (Pt(t, !0, "flex"), i || (i = t)) : Pt(t, !1)
                }), this.switchActiveMention(i || e.children[0]), Pt(this.dialog), this.moveDialog(), this.bus.emit("switchDisabledState", !0)
            }
        }

        closeDialog() {
            Kt(this.dialog) && (Pt(this.dialog, !1), this.switchActiveMention(), this.bus.emit("switchDisabledState", !1))
        }
        ...
        pinyinMatchDialog(t) {
            return t ? this.options.filter(e => Bt(e.name, e.pinyin || "", t)) : this.callEvery ? [{
                id: "ALL",
                name: this.everyText
        ...
        async asyncMatchDialog(t = "") {
            ...
            if (e === this.matchKey) {
                ...
                Pt(s, !0, "flex"), t.scrollTop = 0, Pt(e, 0 === this.options.length, "flex"), Pt(s, !1), this.switchActiveMention(t.children[0]), this.moveDialog()
            }
        }
    ...
    t = new WeakMap, e = new WeakSet, i = function () {
        ...
        this.bus.on(t, "closeDialog", () => {
            this.closeDialog()
        }), this.bus.on(t, "moveActiveMention", $t(this.moveActiveMention, 120).bind(this)), this.bus.on(t, "matchDialog", Lt(this.matchDialog, 200).bind(this)), this.bus.on(t, "destroy", () => {
            this.destroy()
        })
    }, s = function () {
        rt(this, t, [[this.chatElement.richText, {
            keydown: t => {
                Kt(this.dialog) && (Rt(t, "dialog-options") ? t.preventDefault() : Rt(t, "text-move") && this.closeDialog())
            }, keyup: t => {
                if (t.stopPropagation(), "@" === t.key || "2" === String(t.key) || Rt(t, "IME")) {
            ...
            click: () => {
                ...
                Kt(this.dialog) && Rt(t, "dialog-options") && (t.preventDefault(), "ArrowUp" === t.key || "ArrowUp" === t.code ? this.bus.emit("moveActiveMention", "up") : "ArrowDown" === t.key || "ArrowDown" === t.code ? this.bus.emit("moveActiveMention", "down") : "Enter" !== t.key && "Enter" !== t.code && "NumpadEnter" !== t.code || this.activeMention && this.activeMention.click())
            }
        }]]), ct(this, t).forEach(t => {
            const e = t[0], i = t[1];
        ...
        this.dialog.classList.add("chat-mention-dialog-wrap"), Pt(this.dialog, !1);
    ...
    class _t {
        ...
        openDialog(t) {
            if (Kt(this.dialog) || this.bus.emit("closeDialog"), this.options.length > 0) {
                ...
                Array.from(e.children, t => {
                    const e = t.getAttribute("data-id");
                    s.includes(e) ? (Pt(t, !0, "flex"), i || (i = t)) : Pt(t, !1)
                }), this.switchActiveTrigger(i || e.children[0]), Pt(this.dialog), this.moveDialog(), this.bus.emit("switchDisabledState", !0)
            }
        }

        closeDialog() {
            Kt(this.dialog) && (Pt(this.dialog, !1), this.switchActiveTrigger(), this.bus.emit("switchDisabledState", !1))
        }
        ...
        pinyinMatchDialog(t) {
            return t ? this.options.filter(e => Bt(e.name, e.pinyin || "", t)) : this.options
        }

        destroy() {
            const t = "TriggerDialog-" + this.key;
            this.bus.offKeyEvent(t), this.dialog.parentElement && this.dialog.parentElement.removeChild(this.dialog), ct(this, a).forEach(t => {
                const e = t[0], i = t[1];
                for (const s in i) e.removeEventListener(s, i[s])
            })
        }
    ...
    a = new WeakMap, o = new WeakSet, c = function () {
        ...
        this.bus.on(t, "closeDialog", () => {
            this.closeDialog()
        }), this.bus.on(t, "moveActiveTrigger", $t(this.moveActiveTrigger, 120).bind(this)), this.bus.on(t, "matchDialog", Lt(this.matchDialog, 200).bind(this)), this.bus.on(t, "destroy", () => {
            this.destroy()
        })
    }, h = function () {
        rt(this, a, [[this.chatElement.richText, {
            keydown: t => {
                ...
                if (t.stopPropagation(), this.keyMap.includes(String(t.key)) || Rt(t, "IME")) {
                    const t = this.chatElement.chat.getSelection(), e = t.focusNode,
                        i = this.chatElement.chat.chatEditor.findNode(e);
                    if (i && "Write" === i.type) {
                        const e = t.focusOffset;
            ...
            click: () => {
                ...
                Kt(this.dialog) && Rt(t, "dialog-options") && (t.preventDefault(), "ArrowUp" === t.key || "ArrowUp" === t.code ? this.bus.emit("moveActiveTrigger", "up") : "ArrowDown" === t.key || "ArrowDown" === t.code ? this.bus.emit("moveActiveTrigger", "down") : "Enter" !== t.key && "Enter" !== t.code && "NumpadEnter" !== t.code || this.activeTrigger && this.activeTrigger.click())
            }
        }]]), ct(this, a).forEach(t => {
            const e = t[0], i = t[1];
            for (const s in i) e.addEventListener(s, i[s])
        ...
        this.dialog.classList.add("chat-trigger-dialog-wrap"), Pt(this.dialog, !1);
        const t = document.createDocumentFragment(), e = document.createElement("div");
        ...
        this.options.forEach(t => {
            const e = document.createElement("div");
            e.setAttribute("data-id", t.id), e.setAttribute("data-name", t.name), e.classList.add("chat-trigger-dialog-item"), Pt(e, !0, "flex");
            const i = document.createElement("div");
    ...
    class Ft {
        constructor(t, e) {
            ht(this, d), at(this, "chatElement"), at(this, "bus"), at(this, "dialog"), at(this, "title", ""), at(this, "key", ""), at(this, "multiple", !1), at(this, "emptyText", ""), at(this, "options", []), at(this, "selectNode", null), ht(this, l, []), this.dialog = document.createElement("div"), this.chatElement = t, this.bus = this.chatElement.chat.bus, this.title = e.dialogTitle, this.key = e.key, this.multiple = e.multiple || !1, this.emptyText = e.emptyText || "请选择标签选项", this.options = e.options, lt(this, d, p).call(this), lt(this, d, g).call(this), lt(this, d, f).call(this)
        }

        openDialog(t) {
            if (Kt(this.dialog) || this.bus.emit("closeDialog"), this.selectNode = t, !this.selectNode) return;
            Pt(this.dialog);
            ...
            if (s > e.y ? (s = -(e.height + 16), i.style.top = "-16px", i.style.bottom = "auto", i.style.transform = "rotate(0deg)") : (i.style.transform = "rotate(180deg)", i.style.bottom = "-16px", i.style.top = "auto"), window.innerWidth - e.x < this.dialog.clientWidth) {
                ...
                this.dialog.style.left = "auto", this.dialog.style.right = "10px", i.style.left = "auto", i.style.right = t - 16 + "px"
            } else this.dialog.style.left = e.x + "px", this.dialog.style.right = "auto", i.style.left = "16px", i.style.right = "auto";
            ...
            if ("Select" === this.selectNode.type) {
                const t = this.selectNode.id, e = (t || "").split(",");
                this.selectNode.$el.children[0].classList.add("active"), Array.from(a, i => {
                    const s = i.lastChild,
                        n = e.length > 0 ? e.some(t => String(t) === i.getAttribute("data-id")) : String(t) === String(i.getAttribute("data-id"));
                    n && (h = i.clientHeight, c = !0), n || c || (o += i.clientHeight), Pt(s, n)
                });
                const i = o - n.clientHeight / 2 + h / 2;
                n.scrollTop = c && i > 0 ? i : 0
        ...
        closeDialog() {
            if (Kt(this.dialog)) {
                if (Pt(this.dialog, !1), this.selectNode && "Select" === this.selectNode.type) {
    ...
    l = new WeakMap, d = new WeakSet, p = function () {
        ...
        this.dialog.classList.add("chat-select-dialog-wrap"), Pt(this.dialog, !1);
        const t = document.createDocumentFragment(), e = document.createElement("div");
    ...
    class Yt {
        constructor(t, e) {
            ht(this, m), at(this, "chatElement"), at(this, "bus"), at(this, "tip"), at(this, "dialog"), at(this, "config", {}), ht(this, u, []), this.chatElement = t, this.bus = this.chatElement.chat.bus, this.tip = document.createElement("div"), this.dialog = document.createElement("div"), lt(this, m, x).call(this), lt(this, m, y).call(this), lt(this, m, w).call(this), this.updateConfig(e)
        }
        ...
        openTip(t) {
            this.tip.innerHTML = At(this.tip.innerHTML, t), this.dialog.innerHTML = At(this.dialog.innerHTML, t), Pt(this.tip);
            (this.config.closeNames || []).forEach(t => {
                ...
                Pt(this.dialog), this.tip.classList.add("tip-hover");
                ...
                Pt(this.dialog, !1), this.tip.classList.remove("tip-hover")
            };
            const e = this.tip.children[0].clientWidth;
            this.chatElement.container.style.setProperty("--chat-before-tip-width", `${e + Number(t.offset || 4)}px`), this.bus.emit("focus", "mark"), lt(this, m, E).call(this), this.bus.emit("tipState", !0)
        }

        closeTip() {
            Kt(this.tip) && (this.chatElement.container.style.setProperty("--chat-before-tip-width", "0px"), this.chatElement.container.style.setProperty("--chat-before-tip-top", "0px"), this.chatElement.container.style.setProperty("--chat-tip-dialog-left", "0px"), Pt(this.tip, !1), Pt(this.dialog, !1), this.tip.classList.remove("tip-hover"), this.bus.emit("focus", "mark"), this.tip.innerHTML = this.config.tipTemplate || "", this.dialog.innerHTML = this.config.dialogTemplate || "", this.bus.emit("tipState", !1))
        }

        destroy() {
            this.bus.offKeyEvent("BeforeTip"), ct(this, u).forEach(t => {
                const e = t[0], i = t[1];
                for (const s in i) e.removeEventListener(s, i[s])
            })
        }
    ...
    u = new WeakMap, m = new WeakSet, x = function () {
        ...
        this.tip.classList.add("chat-before-tip-wrap"), this.dialog.classList.add("chat-tip-dialog-wrap"), this.chatElement.rollBox.appendChild(this.tip), this.chatElement.dialogRoot.appendChild(this.dialog), Pt(this.tip, !1), Pt(this.dialog, !1)
    }, E = function () {
        if (!Kt(this.tip)) return;
    ...
    class Vt {
        constructor(t, e) {
            ht(this, v), at(this, "chat"), at(this, "container"), at(this, "rollBox"), at(this, "richText"), at(this, "placeholder"), at(this, "dialogRoot"), at(this, "mentionDialog"), at(this, "triggerDialogs"), at(this, "selectDialogs"), at(this, "beforeTip"), this.chat = e, this.container = t, this.rollBox = document.createElement("div"), this.richText = document.createElement("div"), this.placeholder = document.createElement("div"), this.dialogRoot = document.createElement("div"), lt(this, v, b).call(this), lt(this, v, k).call(this), lt(this, v, N).call(this), lt(this, v, C).call(this)
        }
        ...
        createMentionDialog() {
            this.mentionDialog ? this.mentionDialog.updateConfig(this.chat.options.mentionConfig) : this.mentionDialog = new zt(this, this.chat.options.mentionConfig)
        }
        ...
        createTriggerDialog() {
            this.triggerDialogs ? (this.triggerDialogs.forEach(t => {
                ...
                this.triggerDialogs.push(new _t(this, t))
            })
        }
        ...
        createSelectDialog() {
            this.selectDialogs ? (this.selectDialogs.forEach(t => {
                ...
                this.selectDialogs.push(new Ft(this, t))
            })
        }

        createBeforeTip() {
            this.beforeTip ? this.beforeTip.updateConfig(this.chat.options.tipConfig) : this.beforeTip = new Yt(this, this.chat.options.tipConfig)
        }
    ...
    v = new WeakSet, b = function () {
        ...
        this.placeholder.classList.add("chat-placeholder-wrap"), Pt(this.placeholder), this.container.appendChild(this.placeholder)
    }, C = function () {
        this.dialogRoot.classList.add("chat-dialog-wrap"), this.container.appendChild(this.dialogRoot)
    }, O = function () {
        if (this.chat.chatEditor.isComposition) return Pt(this.placeholder, !1);
        const t = this.chat.chatEditor.NODES;
        return t.length > 1 || t[0].children.length > 1 || t[0].children[0].text.length > 0 ? Pt(this.placeholder, !1) : void Pt(this.placeholder, !0)
    };
    ...
    let Gt = class t extends jt {
        constructor(t, e) {
            super(e.type), ht(this, D), at(this, "context"), at(this, "text", ""), at(this, "VOID_KEY", St), this.context = t, this.text = String(e.text || ""), this.render(e)
        }
        ...
        updateNode() {
            ...
            if (this.text = i.replace(new RegExp(this.VOID_KEY, "ig"), "") || "", t.setAttribute(xt, String(!Boolean(this.text))), Boolean(this.text)) {
        ...
        render(t) {
            const e = document.createElement("span");
            this.$el = e, e.setAttribute(yt, Et), e.classList.add("chat-write-wrap");
            const i = document.createElement("span");
            i.classList.add("chat-write-input"), i.setAttribute(yt, vt), i.setAttribute(xt, String(!Boolean(this.text))), i.appendChild(document.createTextNode(Boolean(this.text) ? this.text : this.VOID_KEY)), e.appendChild(i), this.mount({
    ...
    class Zt extends Ut {
        ...
        render(t) {
            const e = document.createElement("span");
            this.$el = e, e.setAttribute(yt, bt), e.setAttribute("contenteditable", "false"), e.classList.add("chat-tag-wrap");
            const i = document.createElement("span");
    ...
    class qt extends Ut {
        ...
        render(t) {
            const e = document.createElement("span");
            this.$el = e, e.setAttribute(yt, kt), e.setAttribute("contenteditable", "false"), e.classList.add("chat-tag-wrap");
            const i = document.createElement("span");
    ...
    class Xt extends Ut {
        ...
        render(t) {
            const e = document.createElement("span");
            this.$el = e, e.setAttribute(yt, Nt), e.setAttribute("contenteditable", "false"), e.classList.add("chat-tag-wrap");
            const i = document.createElement("span");
    ...
    class Jt extends jt {
        ...
        updateNode() {
            const t = this.$el.children[0].children[0], e = this.$el.children[0].children[1], i = t.childNodes[0],
                s = i.textContent || "";
            if (this.text = s.replace(new RegExp(`${this.WRAP_KEY[0]}|${this.VOID_KEY}`, "ig"), ""), Pt(e, !Boolean(this.text), "inline-block"), Boolean(this.text)) {
        ...
        render(t) {
            const e = document.createElement("span");
            this.$el = e, e.setAttribute(yt, Ct), e.setAttribute("contenteditable", "false"), e.classList.add("chat-tag-wrap");
            const i = document.createElement("span");
            ...
            n.classList.add("input-tip"), n.textContent = `[${this.placeholder}]`, i.appendChild(n), Boolean(this.text) && Pt(n, !1), e.addEventListener("click", () => {
    ...
    class Qt extends Ut {
        ...
        render(t) {
            const e = document.createElement("span");
            this.$el = e, e.setAttribute(yt, Ot), e.setAttribute("contenteditable", "false"), e.classList.add("chat-tag-wrap"), e.innerHTML = this.html, this.mount({
                parentElm: (null == t ? void 0 : t.parentElm) || this.context.$el,
                targetElm: this.$el, ...t || {}
            })
        }
    ...
    class te extends jt {
        ...
        splitWriteNode(t, e) {
            ...
            t.text = s, t.syncNode();
            const a = new Gt(this, {type: "Write", text: n, afterElm: t.$el});
        ...
        render(t, e) {
            ...
            this.$el = i, i.className = "chat-grid-wrap", i.setAttribute(yt, wt), this.renderChildren(t, !1), this.mount({
        ...
        renderChildren(t, e = !0) {
            ...
            i.forEach(t => {
                ...
                switch (t.type) {
                    case"Write":
                        e = new Gt(this, {...t, parentElm: s}), this.children.push(e);
                        break;
                    case"Mention":
                        e = new Zt(this, {...t, parentElm: s}), this.children.push(e);
                        break;
                    case"Trigger":
    ...
    class ee {
        constructor(t) {
            ht(this, I), at(this, "$el"), at(this, "bus"), at(this, "chat"), at(this, "isComposition", !1), at(this, "textLength", 0), ht(this, A, !1), at(this, "NODES", []), at(this, "NODE_HEIGHT", 24), at(this, "IME_MODEL", !1), at(this, "FIX_MODEL", !1), ht(this, W, []), at(this, "components", {}), at(this, "markCursorWrite", {
                node: null,
                offset: 0,
                instance: null
                ...
                offset: 0,
                instance: null
            }), at(this, "markLastType", "Write"), at(this, "undoHistory", []), at(this, "redoHistory", []), at(this, "historyLoading", !1), this.chat = t, this.bus = t.bus, this.$el = t.chatElement.richText, lt(this, I, R).call(this), lt(this, I, B).call(this), this.initEditor()
        }
        ...
        async fixEditor(t) {
            this.$el.innerHTML = "", t || (t = this.compileNodes(this.NODES)), this.NODES = t.map(t => new te(this, t)), this.focusLast(), await lt(this, I, j).call(this)
        }
        ...
        findNode(t, e = 5, i = !0) {
            ...
            if (n === bt || n === kt || n === Nt || n === Ct || n === Ot || n === Dt) {
                const t = s, e = t.parentElement, i = Array.prototype.indexOf.call(e.children, t),
                    n = Array.prototype.indexOf.call(this.$el.children, e);
                return this.NODES[n].children[i]
            }
        ...
        async insertText(t) {
            const e = t.replace(new RegExp(`${St}`, "ig"), "").replace(/\r\n/g, "\n").replace(/\r/g, "\n").split("\n").map(t => [{
                type: "Write",
                text: t
            }]);
        ...
        async insertNodes(t) {
            ...
            }), c && c.mergeNode(), h ? h.mergeNode(!0) : n.mergeNode(!0), await lt(this, I, j).call(this)
        }

        async insertInputText(t) {
            const {instance: e, offset: i} = this.markCursorInput;
            if (!e) return;
            const s = e, n = t.replace(new RegExp(`${St}`, "ig"), "").replace(/\r\n/g, "\n").replace(/\r/g, "\n");
            s.setText(i, n), await lt(this, I, j).call(this)
        }
        ...
        async insertMention(t) {
            ...
            const {index: i, write: s, grid: n} = e,
                a = new Zt(n, {type: "Mention", id: t.id, name: t.name, afterElm: s.$el});
            n.children.splice(i + 1, 0, a), await lt(this, I, j).call(this)
        }
        ...
        async insertTrigger(t) {
            ...
            if (!e) return;
            const {index: i, write: s, grid: n} = e,
                a = new qt(n, {type: "Trigger", id: t.id, name: t.name, key: t.key, afterElm: s.$el});
            n.children.splice(i + 1, 0, a), await lt(this, I, j).call(this)
        }
        ...
        async insertSelect(t) {
            ...
            if (!e) return;
            const {index: i, write: s, grid: n} = e,
                a = new Xt(n, {type: "Select", id: t.id, name: t.name, key: t.key, afterElm: s.$el});
            n.children.splice(i + 1, 0, a), await lt(this, I, j).call(this)
        }
        ...
        async insertInput(t) {
            ...
            if (!e) return;
            const {index: i, write: s, grid: n} = e,
                a = new Jt(n, {type: "Input", text: t.text, placeholder: t.placeholder, key: t.key, afterElm: s.$el});
            n.children.splice(i + 1, 0, a), a.focus(-1), await lt(this, I, j).call(this)
        }

        async insertCustom(t) {
            const e = this.splitWrite(t);
            if (!e) return;
            const {index: i, write: s, grid: n} = e, a = new Qt(n, {type: "Custom", html: t.html, afterElm: s.$el});
            n.children.splice(i + 1, 0, a), await lt(this, I, j).call(this)
        }
        ...
        async reset(t) {
            ...
            this.markLastType = "Write", await this.chat.nextTick(), this.focusLast(), await lt(this, I, j).call(this, !t.clearHistory)
        }
        ...
        async insertComponent(t, e) {
            ...
            o.children.splice(n + 1, 0, c), await lt(this, I, j).call(this)
        }
    }
    ...
    A = new WeakMap, W = new WeakMap, I = new WeakSet, R = function () {
        ...
        rt(this, W, [[this.$el, {
            keydown: t => {
                if (this.isComposition = t.isComposing, this.chat.deviceInfo.isPc || !Rt(t, "IME")) {
                    if (!this.IME_MODEL) if (this.isComposition || !Rt(t, "text-backspace") && !Rt(t, "text-delete")) this.chat.options.keyboardWrapFun(t) || !this.chat.deviceInfo.isPc && "Enter" === t.key ? (t.preventDefault(), t.stopPropagation(), lt(this, I, P).call(this)) : !ct(this, A) && this.chat.options.keyboardSendFun(t) ? (t.preventDefault(), t.stopPropagation(), this.isComposition || this.bus.emit("send")) : Rt(t, "text-select-all") ? (t.preventDefault(), t.stopPropagation(), this.selectAll()) : Rt(t, "text-move") ? (t.preventDefault(), t.stopPropagation(), this.isComposition || this.cursorMove("ArrowLeft" === t.key || "ArrowLeft" === t.code ? -1 : 1)) : Rt(t, "text-undo") ? (t.preventDefault(), t.stopPropagation(), lt(this, I, F).call(this)) : Rt(t, "text-redo") && (t.preventDefault(), t.stopPropagation(), lt(this, I, Y).call(this)); else {
                        t.preventDefault(), t.stopPropagation();
                        const e = Rt(t, "text-delete");
                        lt(this, I, H).call(this, e)
                    }
                ...
                this.chat.nextTick(async () => {
                    ...
                    this.NODES[a].children[o].focus(s), "insertParagraph" === t.inputType ? await lt(this, I, P).call(this) : "deleteContentBackward" === t.inputType && await lt(this, I, H).call(this), this.IME_MODEL = !1, this.FIX_MODEL = !1
                })
            }, input: () => {
                this.FIX_MODEL || (this.IME_MODEL = !1, lt(this, I, j).call(this))
            }, copy: t => {
                t.stopPropagation(), t.preventDefault(), lt(this, I, K).call(this, t)
            }, cut: t => {
                t.stopPropagation(), t.preventDefault(), lt(this, I, K).call(this, t), lt(this, I, H).call(this)
            }, paste: t => {
            ...
            keydown: t => {
                (Rt(t, "text-undo") || Rt(t, "text-redo")) && (t.preventDefault(), t.stopPropagation())
            }
        }]]), ct(this, W).forEach(t => {
            const e = t[0], i = t[1];
            for (const s in i) e.addEventListener(s, i[s])
        })
    }, H = async function (t = !1) {
        ...
        if (n && a) {
            ...
            await lt(this, I, j).call(this)
        }
    }, P = async function () {
        if (this.isComposition) return;
        let t = this.chat.getSelection();
        t.isCollapsed || await lt(this, I, H).call(this), t = this.chat.getSelection();
        ...
        if (h === r) {
            ...
            return void i.setData(Tt, JSON.stringify(y))
        }
        ...
        O.unshift(k[0]), O.push(C[0]), i.setData(Tt, JSON.stringify(O))
    }, z = async function (t) {
        const e = t.clipboardData, i = e.getData("text/plain");
        if (!i) return;
        if ("Input" === this.markLastType) return void this.insertInputText(i);
        const s = e.getData(Tt) || "";
        let n = [];
        try {
            n = JSON.parse(s)
        } catch (a) {
        }
        this.chat.getSelection().isCollapsed || await lt(this, I, H).call(this), n && n.length > 0 ? this.insertNodes(n) : this.insertText(i)
    }, _ = function () {
        ...
        this.redoHistory.push(t), this.undoHistory.pop(), await lt(this, I, V).call(this, e)
    }, Y = async function () {
        if (this.historyLoading || this.redoHistory.length <= 0) return;
        const t = this.redoHistory[this.redoHistory.length - 1];
        this.redoHistory.pop(), this.undoHistory.push(t), await lt(this, I, V).call(this, t)
    }, V = async function (t) {
        this.historyLoading = !0, this.$el.innerHTML = "", this.NODES = t.nodes.map(t => new te(this, t));
        this.NODES[t.gridIndex].children[t.childIndex].focus(t.offset), await lt(this, I, j).call(this, !1), this.historyLoading = !1
        ...
        return s && lt(this, I, G).call(this, {
            ...
            instance: s
        }), await this.chat.nextTick(), this.isComposition || (null == s || s.updateNode(), lt(this, I, U).call(this), this.chat.deviceInfo.isPc && t && !this.historyLoading && this.bus.emit("recordHistory")), s && this.cursorView(), this.bus.emit("editorChange"), !this.isComposition && s && "Write" === s.type && this.bus.emit("matchDialog"), !0
    }, G = function (t) {
        if (!t) {
            const e = this.chat.getSelection(), i = e.focusNode, s = this.findNode(i);
            if (!s) return;
        ...
        if (this.NODES.forEach((t, s) => {
            let n = 0;
            n = s > 0 && 1 === t.children.length && 0 === t.children[0].text.length ? 1 : t.$el.textContent.replace(new RegExp(St, "ig"), "").length, i.push(n), e += n
        }), e > t) {
            const s = e - t;
            let n = 0, a = 0;
    ...
    X = new WeakMap, J = new WeakSet, Q = function (t, ...e) {
        ...
        Array.from(t.children, (t, i) => {
            ...
            if (a) {
                a.update && (ct(this, X)[s] = n, n.removeAttribute("data-update"), delete a.update);
                for (const t in a) {
                    const e = a[t];
    ...
    class se {
        constructor(t, e) {
            ...
            }()), at(this, "chatElement"), at(this, "chatEditor"), at(this, "bus"), this.options = Object.assign({}, gt, e || {}, {mentionConfig: void 0}), this.deviceInfo.isTablet && (this.deviceInfo.isPc = !1), this.options.device) {
                case"pc":
            ...
            this.bus = new ie, this.chatElement = new Vt(t, this), this.chatEditor = new ee(this), this.updateConfig(e)
        }

        updateConfig(t) {
            Mt(t.placeholder) && this.chatElement.updatePlaceholder(t.placeholder), Mt(t.chatStyle) && this.chatElement.updateChatStyle(t.chatStyle), Mt(t.maxLength) && (this.options.maxLength = t.maxLength <= 0 ? -1 : t.maxLength, this.bus.emit("ruleMaxLength")), Mt(t.keyboardWrapFun) && (this.options.keyboardWrapFun = t.keyboardWrapFun), Mt(t.keyboardSendFun) && (this.options.keyboardSendFun = t.keyboardSendFun), Mt(t.mentionConfig) && (this.options.mentionConfig = Object.assign({}, this.options.mentionConfig || ft, t.mentionConfig), this.chatElement.createMentionDialog()), Mt(t.triggerConfig) && (this.options.triggerConfig = t.triggerConfig.map(t => (t.keyMap || (t.keyMap = ut[t.key] || []), t)), this.chatElement.createTriggerDialog()), Mt(t.selectConfig) && (this.options.selectConfig = t.selectConfig, this.chatElement.createSelectDialog()), Mt(t.tipConfig) && (this.options.tipConfig = Object.assign({}, mt, t.tipConfig), this.chatElement.createBeforeTip())
        }
        ...
        getHtml(t) {
            ...
            return s.forEach((t, s) => {
                ...
                t.forEach((t, n) => {
                    ...
                    switch (t.type) {
                        case"Mention":
                            c += 'class="chat-tag-mention"', e.saveTagData && (c += ` data-id="${t.id}"`), c += `>@${Wt(t.name)}`;
                            break;
                        case"Trigger":
                            c += 'class="chat-tag-trigger"', e.saveTagData && (c += ` data-id="${t.id}" data-key=${t.key}`), c += `>${t.key}${Wt(t.name)}`;
                            break;
                        case"Select":
                            c += 'class="chat-tag-select"', e.saveTagData && (c += ` data-id="${t.id}" data-key=${t.key}`), c += `>${Wt(t.name)}`;
                            break;
                        case"Input":
                            c += 'class="chat-tag-input"', e.saveTagData && (c += ` data-placeholder="${t.placeholder}" data-key=${t.key}`), c += `>${Wt(t.text || t.placeholder)}`;
                            break;
                        case"Custom":
                            c += 'class="chat-tag-custom"', c += `>${t.html}`;
                            break;
                        case"Write":
                            c += 'class="chat-tag-write"', a = Wt(t.text), e.identifyLink ? c += `>${a.replace(i, t => `<a class="chat-tag-link" href="${t}" target="_blank">${t}</a>`)}` : c += `>${a}`;
                            break;
                        default:
        ...
        getText() {
            let t = "";
            return this.chatEditor.compileNodes(this.chatEditor.NODES).forEach((e, i) => {
                0 !== i && (t += "\n"), e.forEach((e, s) => {
                    switch (e.type) {
                        case"Write":
                            t += e.text;
        ...
        async setHtml(t) {
            await this.chatEditor.insertCustom({html: `<span style="display: inline-block;">${It(t)}</span>`})
        }
    ...
    return at(se, "version", "1.2.2"), at(se, "Component", class extends Ut {
        constructor(t) {
            var e;
            super(t.type, t.context), ht(this, J), at(this, "data", {}), ht(this, X, {}), this.data = t.data || {}, this.$el = document.createElement("span"), this.$el.setAttribute(yt, Dt), this.$el.setAttribute("contenteditable", "false"), this.$el.classList.add("chat-tag-wrap"), this.$el.innerHTML = this.render(), lt(this, J, tt).call(this, this.$el), this.mount({
