!function (t, e) {
    ...
    const nt = '<div class="ant-spin ant-spin-spinning" aria-live="polite" aria-busy="true"><span class="ant-spin-dot ant-spin-dot-spin"><i class="ant-spin-dot-item"></i><i class="ant-spin-dot-item"></i><i class="ant-spin-dot-item"></i><i class="ant-spin-dot-item"></i></span></div>',
        ...
        }, rt = "data-set-empty", lt = "data-set-richType", dt = "richGrid", pt = "richMark", gt = "richWrite",
        ft = "richMention", ut = "richTrigger", mt = "richSelect", xt = "richInput", yt = "richCustom",
        wt = "application/chat-nodes", Et = "\ufeff", vt = (t, e, i = !1) => {
            let s;
            return function (...n) {
                const a = this, o = i && !s;
        ...
        }, kt = t => null != t, Nt = (t, e) => t.replace(/{{(\w+)}}/g, (t, i) => void 0 !== e[i] ? e[i] : t);
        ...
        for (let r = 0; r <= o; r++) for (let t = 0; t <= c; t++) if (h[r][t] && t < c) {
            ...
            for (let i = r; i < o; i++) {
                ...
                if ("char" === e.type) s.char === e.value && (h[i + 1][t + 1] = !0); else {
                    ...
                    if (r === c) h[i + 1][t + 1] = !0; else if (r === a) h[i + 1][t + 1] = !0; else if (St(r, a)) h[i + 1][t + 1] = !0; else for (let e = 2; e <= o - i; e++) {
    ...
    class $t {
        constructor(a, o) {
            tt(this, e), q(this, "chatElement"), q(this, "bus"), q(this, "dialog"), q(this, "activeMention", null), q(this, "title", ""), q(this, "callEvery", !0), q(this, "everyText", ""), q(this, "emptyText", ""), q(this, "options", []), q(this, "asyncMatch"), q(this, "matchKey", 0), tt(this, t, []), this.dialog = document.createElement("div"), this.chatElement = a, this.bus = this.chatElement.chat.bus, it(this, e, i).call(this), it(this, e, s).call(this), it(this, e, n).call(this), this.updateConfig(o)
        }
        ...
        getRenderMention(t) {
            ...
            e.setAttribute("data-id", t.id), e.setAttribute("data-name", t.name), e.classList.add("chat-mention-dialog-item"), Lt(e, !0, "flex");
            const i = document.createElement("div");
            if (i.classList.add("chat-mention-dialog-item-avatar"), t.avatar) {
                i.classList.add("have-avatar");
                const e = document.createElement("div");
                e.classList.add("chat-mention-dialog-item-avatar-loading"), e.innerHTML = nt, i.appendChild(e);
                const s = new Image;
        ...
        openDialog(t) {
            if (Mt(this.dialog) || this.bus.emit("closeDialog"), this.asyncMatch) {
                this.options = [], this.updateRender();
                const t = this.dialog.children[2], e = this.dialog.children[3];
                Lt(t, !1), Lt(e, !0, "flex"), Lt(this.dialog), this.moveDialog(), this.bus.emit("switchDisabledState", !0)
                ...
                Array.from(e.children, t => {
                    ...
                    s.includes(e) ? (Lt(t, !0, "flex"), i || (i = t)) : Lt(t, !1)
                }), this.switchActiveMention(i || e.children[0]), Lt(this.dialog), this.moveDialog(), this.bus.emit("switchDisabledState", !0)
            }
        }

        closeDialog() {
            Mt(this.dialog) && (Lt(this.dialog, !1), this.switchActiveMention(), this.bus.emit("switchDisabledState", !1))
        }
        ...
        pinyinMatchDialog(t) {
            return t ? this.options.filter(e => Tt(e.name, e.pinyin || "", t)) : this.callEvery ? [{
                id: "ALL",
                name: this.everyText
        ...
        async asyncMatchDialog(t = "") {
            ...
            if (e === this.matchKey) {
                ...
                Lt(s, !0, "flex"), t.scrollTop = 0, Lt(e, 0 === this.options.length, "flex"), Lt(s, !1), this.switchActiveMention(t.children[0])
            }
        }

        destroy() {
            this.bus.offKeyEvent("MentionDialog"), this.dialog.parentElement && this.dialog.parentElement.removeChild(this.dialog), Q(this, t).forEach(t => {
                const e = t[0], i = t[1];
    ...
    t = new WeakMap, e = new WeakSet, i = function () {
        ...
        this.bus.on(t, "closeDialog", () => {
            this.closeDialog()
        }), this.bus.on(t, "moveActiveMention", bt(this.moveActiveMention, 120).bind(this)), this.bus.on(t, "matchDialog", vt(this.matchDialog, 200).bind(this)), this.bus.on(t, "destroy", () => {
            this.destroy()
        })
    }, s = function () {
        et(this, t, [[this.chatElement.richText, {
            keydown: t => {
                Mt(this.dialog) && (Dt(t, "dialog-options") ? t.preventDefault() : Dt(t, "text-move") && this.closeDialog())
            }, keyup: t => {
                if (t.stopPropagation(), "@" === t.key || "2" === String(t.key) || Dt(t, "IME")) {
            ...
            click: () => {
                ...
                Mt(this.dialog) && Dt(t, "dialog-options") && (t.preventDefault(), "ArrowUp" === t.key || "ArrowUp" === t.code ? this.bus.emit("moveActiveMention", "up") : "ArrowDown" === t.key || "ArrowDown" === t.code ? this.bus.emit("moveActiveMention", "down") : "Enter" !== t.key && "Enter" !== t.code && "NumpadEnter" !== t.code || this.activeMention && this.activeMention.click())
            }
        }]]), Q(this, t).forEach(t => {
            const e = t[0], i = t[1];
        ...
        this.dialog.classList.add("chat-mention-dialog-wrap"), Lt(this.dialog, !1);
        ...
        const s = document.createElement("div");
        s.classList.add("chat-mention-dialog-empty"), Lt(s, !1), t.appendChild(s);
        const n = document.createElement("div");
        n.classList.add("chat-mention-dialog-loading"), n.innerHTML = nt, Lt(n, !1), t.appendChild(n), this.dialog.appendChild(t), this.chatElement.dialogRoot.appendChild(this.dialog)
    };

    class At {
        constructor(t, e) {
            tt(this, o), q(this, "bus"), q(this, "chatElement"), q(this, "dialog"), q(this, "activeTrigger", null), q(this, "title"), q(this, "key"), q(this, "options"), q(this, "keyMap"), tt(this, a, []), this.title = e.dialogTitle, this.key = e.key, this.options = e.options, this.keyMap = e.keyMap, this.dialog = document.createElement("div"), this.chatElement = t, this.bus = this.chatElement.chat.bus, it(this, o, c).call(this), it(this, o, h).call(this), it(this, o, r).call(this)
        }

        openDialog(t) {
            if (Mt(this.dialog) || this.bus.emit("closeDialog"), this.options.length > 0) {
                const e = this.dialog.children[1];
                let i;
                e.scrollTop = 0;
                const s = (t || this.pinyinMatchDialog()).map(t => t.id);
                Array.from(e.children, t => {
                    const e = t.getAttribute("data-id");
                    s.includes(e) ? (Lt(t, !0, "flex"), i || (i = t)) : Lt(t, !1)
                }), this.switchActiveTrigger(i || e.children[0]), Lt(this.dialog), this.moveDialog(), this.bus.emit("switchDisabledState", !0)
            }
        }

        closeDialog() {
            Mt(this.dialog) && (Lt(this.dialog, !1), this.switchActiveTrigger(), this.bus.emit("switchDisabledState", !1))
        }
        ...
        pinyinMatchDialog(t) {
            return t ? this.options.filter(e => Tt(e.name, e.pinyin || "", t)) : this.options
        }

        destroy() {
            const t = "TriggerDialog-" + this.key;
            this.bus.offKeyEvent(t), this.dialog.parentElement && this.dialog.parentElement.removeChild(this.dialog), Q(this, a).forEach(t => {
                const e = t[0], i = t[1];
                for (const s in i) e.removeEventListener(s, i[s])
            })
        }
    ...
    a = new WeakMap, o = new WeakSet, c = function () {
        ...
        this.bus.on(t, "closeDialog", () => {
            this.closeDialog()
        }), this.bus.on(t, "moveActiveTrigger", bt(this.moveActiveTrigger, 120).bind(this)), this.bus.on(t, "matchDialog", vt(this.matchDialog, 200).bind(this)), this.bus.on(t, "destroy", () => {
            this.destroy()
        })
    }, h = function () {
        et(this, a, [[this.chatElement.richText, {
            keydown: t => {
                Mt(this.dialog) && (Dt(t, "dialog-options") ? t.preventDefault() : Dt(t, "text-move") && this.closeDialog())
            }, keyup: t => {
                if (t.stopPropagation(), this.keyMap.includes(String(t.key)) || Dt(t, "IME")) {
                    const t = this.chatElement.chat.getSelection(), e = t.focusNode,
                        i = this.chatElement.chat.chatEditor.findNode(e);
                    if (i && "Write" === i.type) {
                        const e = t.focusOffset;
            ...
            click: () => {
                ...
                Mt(this.dialog) && Dt(t, "dialog-options") && (t.preventDefault(), "ArrowUp" === t.key || "ArrowUp" === t.code ? this.bus.emit("moveActiveTrigger", "up") : "ArrowDown" === t.key || "ArrowDown" === t.code ? this.bus.emit("moveActiveTrigger", "down") : "Enter" !== t.key && "Enter" !== t.code && "NumpadEnter" !== t.code || this.activeTrigger && this.activeTrigger.click())
            }
        }]]), Q(this, a).forEach(t => {
            const e = t[0], i = t[1];
            for (const s in i) e.addEventListener(s, i[s])
        ...
        this.dialog.classList.add("chat-trigger-dialog-wrap"), Lt(this.dialog, !1);
        const t = document.createDocumentFragment(), e = document.createElement("div");
        ...
        this.options.forEach(t => {
            const e = document.createElement("div");
            e.setAttribute("data-id", t.id), e.setAttribute("data-name", t.name), e.classList.add("chat-trigger-dialog-item"), Lt(e, !0, "flex");
            const i = document.createElement("div");
    ...
    class Wt {
        constructor(t, e) {
            tt(this, d), q(this, "chatElement"), q(this, "bus"), q(this, "dialog"), q(this, "title", ""), q(this, "key", ""), q(this, "options", []), q(this, "selectNode", null), tt(this, l, []), this.dialog = document.createElement("div"), this.chatElement = t, this.bus = this.chatElement.chat.bus, this.title = e.dialogTitle, this.key = e.key, this.options = e.options, it(this, d, p).call(this), it(this, d, g).call(this), it(this, d, f).call(this)
        }

        openDialog(t) {
            if (Mt(this.dialog) || this.bus.emit("closeDialog"), this.selectNode = t, !this.selectNode) return;
            Lt(this.dialog);
            ...
            if ("Select" === this.selectNode.type) {
                ...
                this.selectNode.$el.children[0].classList.add("active"), Array.from(a, e => {
                    ...
                    s && (h = e.clientHeight, c = !0), s || c || (o += e.clientHeight), Lt(i, s)
                });
        ...
        closeDialog() {
            if (Mt(this.dialog)) {
                if (Lt(this.dialog, !1), this.selectNode && "Select" === this.selectNode.type) {
        ...
        destroy() {
            ...
            this.bus.offKeyEvent(t), this.dialog.parentElement && this.dialog.parentElement.removeChild(this.dialog), Q(this, l).forEach(t => {
                const e = t[0], i = t[1];
                for (const s in i) e.removeEventListener(s, i[s])
            })
        }
    ...
    l = new WeakMap, d = new WeakSet, p = function () {
        ...
        this.dialog.classList.add("chat-select-dialog-wrap"), Lt(this.dialog, !1);
        const t = document.createDocumentFragment(), e = document.createElement("div");
        ...
        this.options.forEach(t => {
            ...
            if (e.classList.add("chat-select-dialog-item"), e.setAttribute("data-id", t.id), e.setAttribute("data-name", t.name), t.preview) {
                const i = document.createElement("div");
                i.classList.add("chat-select-dialog-preview"), i.classList.add("loading"), i.innerHTML = nt, e.appendChild(i);
                const s = new Image;
    ...
    class It {
        constructor(t, e) {
            tt(this, m), q(this, "chatElement"), q(this, "bus"), q(this, "tip"), q(this, "dialog"), q(this, "config", {}), tt(this, u, []), this.chatElement = t, this.bus = this.chatElement.chat.bus, this.tip = document.createElement("div"), this.dialog = document.createElement("div"), it(this, m, x).call(this), it(this, m, y).call(this), it(this, m, w).call(this), this.updateConfig(e)
        }
        ...
        openTip(t) {
            this.tip.innerHTML = Nt(this.tip.innerHTML, t), this.dialog.innerHTML = Nt(this.dialog.innerHTML, t), Lt(this.tip);
            ...
            this.chatElement.container.style.setProperty("--chat-before-tip-width", `${e + Number(t.offset || 4)}px`), this.bus.emit("focus", "mark"), it(this, m, E).call(this), this.bus.emit("tipState", !0)
        }

        closeTip() {
            this.chatElement.container.style.setProperty("--chat-before-tip-width", "0px"), this.chatElement.container.style.setProperty("--chat-before-tip-top", "0px"), this.chatElement.container.style.setProperty("--chat-tip-dialog-left", "0px"), Lt(this.tip, !1), Lt(this.dialog, !1), this.bus.emit("focus", "mark"), this.tip.innerHTML = this.config.tipTemplate || "", this.dialog.innerHTML = this.config.dialogTemplate || "", this.bus.emit("tipState", !1)
        }

        destroy() {
            this.bus.offKeyEvent("BeforeTip"), Q(this, u).forEach(t => {
                const e = t[0], i = t[1];
                for (const s in i) e.removeEventListener(s, i[s])
            })
        }
    ...
    u = new WeakMap, m = new WeakSet, x = function () {
        ...
        this.tip.classList.add("chat-before-tip-wrap"), this.dialog.classList.add("chat-tip-dialog-wrap"), this.chatElement.rollBox.appendChild(this.tip), this.chatElement.dialogRoot.appendChild(this.dialog), Lt(this.tip, !1), Lt(this.dialog, !1)
    }, E = function () {
        if (!Mt(this.tip)) return;
    ...
    class Rt {
        constructor(t, e) {
            tt(this, v), q(this, "chat"), q(this, "container"), q(this, "rollBox"), q(this, "richText"), q(this, "placeholder"), q(this, "dialogRoot"), q(this, "mentionDialog"), q(this, "triggerDialogs"), q(this, "selectDialogs"), q(this, "beforeTip"), this.chat = e, this.container = t, this.rollBox = document.createElement("div"), this.richText = document.createElement("div"), this.placeholder = document.createElement("div"), this.dialogRoot = document.createElement("div"), it(this, v, b).call(this), it(this, v, k).call(this), it(this, v, N).call(this), it(this, v, C).call(this)
        }
        ...
        createMentionDialog() {
            this.mentionDialog ? this.mentionDialog.updateConfig(this.chat.options.mentionConfig) : this.mentionDialog = new $t(this, this.chat.options.mentionConfig)
        }
        ...
        createTriggerDialog() {
            this.triggerDialogs ? (this.triggerDialogs.forEach(t => {
                ...
                this.triggerDialogs.push(new At(this, t))
            })
        }
        ...
        createSelectDialog() {
            this.selectDialogs ? (this.selectDialogs.forEach(t => {
                ...
                this.selectDialogs.push(new Wt(this, t))
            })
        }

        createBeforeTip() {
            this.beforeTip ? this.beforeTip.updateConfig(this.chat.options.tipConfig) : this.beforeTip = new It(this, this.chat.options.tipConfig)
        }
    ...
    v = new WeakSet, b = function () {
        ...
        this.chat.bus.on(t, "editorChange", () => {
            it(this, v, O).call(this)
        }), this.chat.bus.on(t, "destroy", () => {
            this.destroy()
        })
    }, k = function () {
        this.container.classList.add("chat-area-wrap"), this.rollBox.classList.add("chat-rich-text"), this.rollBox.classList.add("chat-scroll"), this.richText.setAttribute(lt, "richWrap"), this.richText.setAttribute("contenteditable", "true"), this.rollBox.appendChild(this.richText), this.container.appendChild(this.rollBox)
    }, N = function () {
        this.placeholder.classList.add("chat-placeholder-wrap"), Lt(this.placeholder), this.container.appendChild(this.placeholder)
    }, C = function () {
        this.dialogRoot.classList.add("chat-dialog-wrap"), this.container.appendChild(this.dialogRoot)
    }, O = function () {
        if (this.chat.chatEditor.isComposition) return Lt(this.placeholder, !1);
        const t = this.chat.chatEditor.NODES;
        return t.length > 1 || t[0].children.length > 1 || t[0].children[0].text.length > 0 ? Lt(this.placeholder, !1) : void Lt(this.placeholder, !0)
    };
    ...
    let Pt = class t extends Bt {
        constructor(t, e) {
            super(e.type), tt(this, D), q(this, "context"), q(this, "text", ""), q(this, "VOID_KEY", Et), this.context = t, this.text = String(e.text || ""), this.render(e)
        }
        ...
        focus(t) {
            ...
            i.setStart(e, t), i.setEnd(e, t), s.removeAllRanges(), s.addRange(i), it(this, D, T).call(this, "cursorChange", {
                node: e,
                offset: t,
                type: "Write"
            })
        ...
        updateNode() {
            ...
            if (this.text = i.replace(new RegExp(this.VOID_KEY, "ig"), "") || "", t.setAttribute(rt, String(!Boolean(this.text))), Boolean(this.text)) {
        ...
        backspace(t) {
            ...
            if (t.isCollapsed) {
                if (0 === e || 1 === e && !Boolean(this.text)) {
                    ...
                    if (0 === t) {
                        if (0 === e) return void it(this, D, T).call(this, "closeTip");
        ...
        render(t) {
            const e = document.createElement("span");
            this.$el = e, e.setAttribute(lt, pt), e.classList.add("chat-write-wrap");
            const i = document.createElement("span");
            i.classList.add("chat-write-input"), i.setAttribute(lt, gt), i.setAttribute(rt, String(!Boolean(this.text))), i.appendChild(document.createTextNode(Boolean(this.text) ? this.text : this.VOID_KEY)), e.appendChild(i), this.mount({
    ...
    class Kt extends Ht {
        ...
        render(t) {
            const e = document.createElement("span");
            this.$el = e, e.setAttribute(lt, ft), e.setAttribute("contenteditable", "false"), e.classList.add("chat-tag-wrap");
            const i = document.createElement("span");
    ...
    class zt extends Ht {
        ...
        render(t) {
            const e = document.createElement("span");
            this.$el = e, e.setAttribute(lt, ut), e.setAttribute("contenteditable", "false"), e.classList.add("chat-tag-wrap");
            const i = document.createElement("span");
    ...
    class _t extends Ht {
        ...
        updateTag({id: t, name: e}) {
            ...
            this.$el.children[0].children[0].textContent = e, this.focus()
        }

        render(t) {
            const e = document.createElement("span");
            this.$el = e, e.setAttribute(lt, mt), e.setAttribute("contenteditable", "false"), e.classList.add("chat-tag-wrap");
            const i = document.createElement("span");
    ...
    class Ft extends Bt {
        ...
        updateNode() {
            const t = this.$el.children[0].children[0], e = this.$el.children[0].children[1], i = t.childNodes[0],
                s = i.textContent || "";
            if (this.text = s.replace(new RegExp(`${this.WRAP_KEY[0]}|${this.VOID_KEY}`, "ig"), ""), Lt(e, !Boolean(this.text), "inline-block"), Boolean(this.text)) {
        ...
        focus(t) {
            ...
            t || 0 === t ? -1 === t && (t = e.textContent === this.VOID_KEY ? 1 : e.textContent.length) : t = e.textContent === this.VOID_KEY ? 1 : 0;
            const i = new Range, s = this.context.context.chat.getSelection();
            i.setStart(e, t), i.setEnd(e, t), s.removeAllRanges(), s.addRange(i), it(this, S, L).call(this, "cursorChange", {
                node: e,
                offset: t,
                type: "Input"
            })
        ...
        setText(t, e) {
            if (e = this.fixWrapKey(e), Boolean(this.text)) {
                const i = this.text.slice(0, t), s = this.text.slice(t);
                this.text = i + e + s, this.syncNode(), this.focus(t + e.length)
        ...
        render(t) {
            const e = document.createElement("span");
            this.$el = e, e.setAttribute(lt, xt), e.setAttribute("contenteditable", "false"), e.classList.add("chat-tag-wrap");
            const i = document.createElement("span");
            ...
            n.classList.add("input-tip"), n.textContent = `[${this.placeholder}]`, i.appendChild(n), Boolean(this.text) && Lt(n, !1), e.addEventListener("click", () => {
    ...
    class Yt extends Ht {
        ...
        render(t) {
            const e = document.createElement("span");
            this.$el = e, e.setAttribute(lt, yt), e.setAttribute("contenteditable", "false"), e.classList.add("chat-tag-wrap"), e.innerHTML = this.html, this.mount({
                parentElm: (null == t ? void 0 : t.parentElm) || this.context.$el,
                targetElm: this.$el, ...t || {}
            })
        }
    ...
    class Vt extends Bt {
        ...
        splitNode(t, e = 0) {
            ...
            this.children = o;
            const h = new Vt(this.context, [], {afterElm: this.$el});
        ...
        splitWriteNode(t, e) {
            ...
            t.text = s, t.syncNode();
            const a = new Pt(this, {type: "Write", text: n, afterElm: t.$el});
        ...
        render(t, e) {
            ...
            this.$el = i, i.className = "chat-grid-wrap", i.setAttribute(lt, dt);
            const s = this.getAnalyzeChildren(t), n = document.createDocumentFragment();
            s.forEach(t => {
                let e;
                switch (t.type) {
                    case"Write":
                        e = new Pt(this, {...t, parentElm: n}), this.children.push(e);
                        break;
                    case"Mention":
                        e = new Kt(this, {...t, parentElm: n}), this.children.push(e);
                        break;
                    case"Trigger":
                        e = new zt(this, {...t, parentElm: n}), this.children.push(e);
                        break;
                    case"Select":
                        e = new _t(this, {...t, parentElm: n}), this.children.push(e);
                        break;
                    case"Input":
                        e = new Ft(this, {...t, parentElm: n}), this.children.push(e);
                        break;
                    case"Custom":
                        e = new Yt(this, {...t, parentElm: n}), this.children.push(e)
                }
            }), this.$el.appendChild(n);
            this.children[this.children.length - 1].ruleBRTag(), this.mount({
    ...
    class jt {
        constructor(t) {
            tt(this, A), q(this, "$el"), q(this, "bus"), q(this, "chat"), q(this, "isComposition", !1), q(this, "textLength", 0), tt(this, M, !1), q(this, "NODES", []), q(this, "NODE_HEIGHT", 24), q(this, "IME_MODEL", !1), q(this, "FIX_MODEL", !1), tt(this, $, []), q(this, "markCursorWrite", {
                node: null,
                offset: 0
            }), q(this, "markCursorInput", {
                node: null,
                offset: 0
            }), q(this, "markLastType", "Write"), q(this, "undoHistory", []), q(this, "redoHistory", []), q(this, "historyLoading", !1), this.chat = t, this.bus = t.bus, this.$el = t.chatElement.richText, it(this, A, W).call(this), it(this, A, I).call(this), this.initEditor()
        }

        initEditor() {
            this.$el.innerHTML = "", this.NODES = [new Vt(this)], this.markLastType = "Write", this.NODE_HEIGHT = this.NODES[0].$el.getBoundingClientRect().height, this.undoHistory = [{
        ...
        async fixEditor(t) {
            this.$el.innerHTML = "", t || (t = this.compileNodes(this.NODES)), this.NODES = t.map(t => new Vt(this, t)), this.focusLast(), await it(this, A, Y).call(this)
        }
        ...
        findNode(t, e = 5) {
            ...
            const i = t, s = i.getAttribute ? i.getAttribute(lt) : "";
            if (s === gt) {
                const t = i.parentElement, e = t.parentElement, s = Array.prototype.indexOf.call(e.children, t),
                    n = Array.prototype.indexOf.call(this.$el.children, e);
                return this.NODES[n].children[s]
            }
            if (s === pt) {
                const t = i, e = t.parentElement, s = Array.prototype.indexOf.call(e.children, t),
                    n = Array.prototype.indexOf.call(this.$el.children, e);
                return this.NODES[n].children[s]
            }
            if (s === ft || s === ut || s === mt || s === xt || s === yt) {
                const t = i, e = t.parentElement, s = Array.prototype.indexOf.call(e.children, t),
                    n = Array.prototype.indexOf.call(this.$el.children, e);
                return this.NODES[n].children[s]
            }
            if (s === dt) {
                const t = Array.prototype.indexOf.call(this.$el.children, i);
                return this.NODES[t]
            }
            return this.findNode(i.parentElement, e - 1)
        }
        ...
        async insertText(t) {
            const e = t.replace(new RegExp(`${Et}`, "ig"), "").replace(/\r\n/g, "\n").replace(/\r/g, "\n").split("\n").map(t => [{
                type: "Write",
                text: t
            }]);
        ...
        async insertNodes(t) {
            const e = this.markCursorWrite.node;
            if (!e) return;
            const i = this.findNode(e), s = i.context, n = this.NODES.indexOf(s);
            s.splitNode(i, this.markCursorWrite.offset);
            let a = s.$el, o = null, c = null;
            t.forEach((e, i) => {
                const s = new Vt(this, e, {afterElm: a});
                a = s.$el, 0 === i ? o = s : i === t.length - 1 && (c = s), this.NODES.splice(n + i + 1, 0, s)
            }), o && o.mergeNode(), c ? c.mergeNode(!0) : s.mergeNode(!0), await it(this, A, Y).call(this)
        }

        async insertInputText(t) {
            const e = this.markCursorInput.node;
            if (!e) return;
            const i = this.findNode(e),
                s = t.replace(new RegExp(`${Et}`, "ig"), "").replace(/\r\n/g, "\n").replace(/\r/g, "\n");
            i.setText(this.markCursorInput.offset, s), await it(this, A, Y).call(this)
        }

        splitWrite(t) {
            const {node: e, offset: i} = this.markCursorWrite;
            if (!e) return null;
            const s = this.findNode(e), n = s.context, a = n.children.indexOf(s);
        ...
        async insertMention(t) {
            ...
            const {index: i, write: s, grid: n} = e,
                a = new Kt(n, {type: "Mention", id: t.id, name: t.name, afterElm: s.$el});
            n.children.splice(i + 1, 0, a), await it(this, A, Y).call(this)
        }
        ...
        async insertTrigger(t) {
            ...
            if (!e) return;
            const {index: i, write: s, grid: n} = e,
                a = new zt(n, {type: "Trigger", id: t.id, name: t.name, key: t.key, afterElm: s.$el});
            n.children.splice(i + 1, 0, a), await it(this, A, Y).call(this)
        }
        ...
        async insertSelect(t) {
            ...
            if (!e) return;
            const {index: i, write: s, grid: n} = e,
                a = new _t(n, {type: "Select", id: t.id, name: t.name, key: t.key, afterElm: s.$el});
            n.children.splice(i + 1, 0, a), await it(this, A, Y).call(this)
        }
        ...
        async insertInput(t) {
            ...
            if (!e) return;
            const {index: i, write: s, grid: n} = e,
                a = new Ft(n, {type: "Input", text: t.text, placeholder: t.placeholder, key: t.key, afterElm: s.$el});
            n.children.splice(i + 1, 0, a), a.focus(-1), await it(this, A, Y).call(this)
        }

        async insertCustom(t) {
            const e = this.splitWrite(t);
            if (!e) return;
            const {index: i, write: s, grid: n} = e, a = new Yt(n, {type: "Custom", html: t.html, afterElm: s.$el});
            n.children.splice(i + 1, 0, a), await it(this, A, Y).call(this)
        }

        async reset(t) {
            if (this.$el.innerHTML = "", this.NODES = t.chatNode.map(t => new Vt(this, t)), t.clearHistory) {
                const t = this.NODES[this.NODES.length - 1], e = t.children[t.children.length - 1];
                this.undoHistory = [{
                    nodes: this.compileNodes(this.NODES),
                    gridIndex: this.NODES.length - 1,
            ...
            this.markLastType = "Write", await this.chat.nextTick(), this.focusLast(), await it(this, A, Y).call(this, !t.clearHistory)
        }

        destroy() {
            this.bus.offKeyEvent("ChatEditor"), Q(this, $).forEach(t => {
                const e = t[0], i = t[1];
                for (const s in i) e.removeEventListener(s, i[s])
            })
        }
    ...
    M = new WeakMap, $ = new WeakMap, A = new WeakSet, W = function () {
        const t = "ChatEditor";
        this.bus.on(t, "richTextChange", async t => {
            await it(this, A, Y).call(this), t && t()
        }), this.bus.on(t, "richTextDelete", async (t, e) => {
            await it(this, A, R).call(this, t), e && e()
        }), this.bus.on(t, "cursorChange", t => {
            it(this, A, V).call(this, t)
        }), this.bus.on(t, "lineBreak", async t => {
            await it(this, A, B).call(this), t && t()
        }), this.bus.on(t, "undo", async t => {
            await it(this, A, z).call(this), t && t()
        }), this.bus.on(t, "redo", async t => {
            await it(this, A, _).call(this), t && t()
        }), this.bus.on(t, "recordHistory", vt(it(this, A, K), 200).bind(this)), this.bus.on(t, "ruleMaxLength", () => {
            it(this, A, j).call(this)
        ...
        et(this, $, [[this.$el, {
            keydown: t => {
                if (this.isComposition = t.isComposing, this.chat.deviceInfo.isPc || !Dt(t, "IME")) {
                    if (!this.IME_MODEL) if (this.isComposition || !Dt(t, "text-backspace") && !Dt(t, "text-delete")) this.chat.options.keyboardWrapFun(t) || !this.chat.deviceInfo.isPc && "Enter" === t.key ? (t.preventDefault(), t.stopPropagation(), it(this, A, B).call(this)) : !Q(this, M) && this.chat.options.keyboardSendFun(t) ? (t.preventDefault(), t.stopPropagation(), this.isComposition || this.bus.emit("send")) : Dt(t, "text-select-all") ? (t.preventDefault(), t.stopPropagation(), this.selectAll()) : Dt(t, "text-move") ? (t.preventDefault(), t.stopPropagation(), this.isComposition || this.cursorMove("ArrowLeft" === t.key || "ArrowLeft" === t.code ? -1 : 1)) : Dt(t, "text-undo") ? (t.preventDefault(), t.stopPropagation(), it(this, A, z).call(this)) : Dt(t, "text-redo") && (t.preventDefault(), t.stopPropagation(), it(this, A, _).call(this)); else {
                        t.preventDefault(), t.stopPropagation();
                        const e = Dt(t, "text-delete");
                        it(this, A, R).call(this, e)
                    }
                ...
                this.chat.nextTick(async () => {
                    this.$el.innerHTML = "", this.NODES = c.map(t => new Vt(this, t));
                    this.NODES[a].children[o].focus(s), "insertParagraph" === t.inputType ? await it(this, A, B).call(this) : "deleteContentBackward" === t.inputType && await it(this, A, R).call(this), this.IME_MODEL = !1, this.FIX_MODEL = !1
                })
            }, input: () => {
                this.FIX_MODEL || (this.IME_MODEL = !1, it(this, A, Y).call(this))
            }, copy: t => {
                t.stopPropagation(), t.preventDefault(), it(this, A, P).call(this, t)
            }, cut: t => {
                t.stopPropagation(), t.preventDefault(), it(this, A, P).call(this, t), it(this, A, R).call(this)
            }, paste: t => {
                t.stopPropagation(), t.preventDefault(), it(this, A, H).call(this, t)
            }, blur: () => {
                it(this, A, V).call(this)
            }, focus: () => {
                it(this, A, V).call(this)
            ...
            keydown: t => {
                (Dt(t, "text-undo") || Dt(t, "text-redo")) && (t.preventDefault(), t.stopPropagation())
            }
        }]]), Q(this, $).forEach(t => {
            const e = t[0], i = t[1];
            for (const s in i) e.addEventListener(s, i[s])
        })
    }, R = async function (t = !1) {
        ...
        if (n && a) {
            ...
            await it(this, A, Y).call(this)
        }
    }, B = async function () {
        if (this.isComposition) return;
        let t = this.chat.getSelection();
        t.isCollapsed || await it(this, A, R).call(this), t = this.chat.getSelection();
        ...
        if (h === r) {
            ...
            return void i.setData(wt, JSON.stringify(y))
        }
        ...
        O.unshift(k[0]), O.push(C[0]), i.setData(wt, JSON.stringify(O))
    }, H = async function (t) {
        const e = t.clipboardData, i = e.getData("text/plain");
        if (!i) return;
        if ("Input" === this.markLastType) return void this.insertInputText(i);
        const s = e.getData(wt) || "";
        let n = [];
        try {
            n = JSON.parse(s)
        } catch (a) {
        }
        this.chat.getSelection().isCollapsed || await it(this, A, R).call(this), n && n.length > 0 ? this.insertNodes(n) : this.insertText(i)
    }, K = function () {
        if ("Input" === this.markLastType) {
            const t = this.markCursorInput.node, e = this.findNode(t), i = e.context;
            this.undoHistory.push({
                nodes: this.compileNodes(this.NODES),
                gridIndex: this.NODES.indexOf(i),
                childIndex: i.children.indexOf(e),
                offset: this.markCursorInput.offset,
                type: "Input"
            })
        } else {
            const t = this.markCursorWrite.node, e = this.findNode(t), i = e.context;
            this.undoHistory.push({
                nodes: this.compileNodes(this.NODES),
                gridIndex: this.NODES.indexOf(i),
                childIndex: i.children.indexOf(e),
                offset: this.markCursorWrite.offset,
                type: "Write"
            })
        }
        ...
        this.redoHistory.push(t), this.undoHistory.pop(), await it(this, A, F).call(this, e)
    }, _ = async function () {
        if (this.historyLoading || this.redoHistory.length <= 0) return;
        const t = this.redoHistory[this.redoHistory.length - 1];
        this.redoHistory.pop(), this.undoHistory.push(t), await it(this, A, F).call(this, t)
    }, F = async function (t) {
        this.historyLoading = !0, this.$el.innerHTML = "", this.NODES = t.nodes.map(t => new Vt(this, t));
        this.NODES[t.gridIndex].children[t.childIndex].focus(t.offset), await it(this, A, Y).call(this, !1), this.historyLoading = !1
    }, Y = async function (t = !0) {
        const e = this.chat.getSelection(), i = e.focusNode, s = this.findNode(i);
        return s && it(this, A, V).call(this, {
            type: s.type,
            node: s.$el.children[0].childNodes[0],
            offset: e.focusOffset
        }), await this.chat.nextTick(), this.isComposition || (null == s || s.updateNode(), it(this, A, j).call(this), this.chat.deviceInfo.isPc && t && !this.historyLoading && this.bus.emit("recordHistory")), s && this.cursorView(), this.bus.emit("editorChange"), !this.isComposition && this.chat.deviceInfo.isPc && s && "Write" === s.type && this.bus.emit("matchDialog"), !0
    }, V = function (t) {
        if (!t) {
            const e = this.chat.getSelection(), i = e.focusNode, s = this.findNode(i);
            if (!s) return;
        ...
        if (t) switch (t.type) {
            case"Write":
                this.markCursorWrite.node = t.node, this.markCursorWrite.offset = t.offset, this.markLastType = "Write";
                break;
            case"Input":
                this.markCursorInput.node = t.node, this.markCursorInput.offset = t.offset, this.markLastType = "Input"
        }
    }, j = function () {
        ...
        if (this.NODES.forEach((t, s) => {
            let n = 0;
            n = s > 0 && 1 === t.children.length && 0 === t.children[0].text.length ? 1 : t.$el.textContent.replace(new RegExp(Et, "ig"), "").length, i.push(n), e += n
        }), e > t) {
            const s = e - t;
            let n = 0, a = 0;
    ...
    class Gt {
        constructor() {
            tt(this, G), tt(this, U), et(this, G, Object.create(null)), et(this, U, Object.create(null))
        }

        on(t, e, i) {
            Q(this, G)[e] || (Q(this, G)[e] = Object.create(null)), Q(this, U)[t] || (Q(this, U)[t] = []), Q(this, U)[t].push(e), Q(this, G)[e][t] = i
        }

        emit(...t) {
            const e = t[0], i = t.slice(1), s = Q(this, G)[e];
            if (s) for (const n in s) s[n](...i)
        }

        off(t, e) {
            for (const i in Q(this, G)[e]) if (i + "" == t + "") {
                delete Q(this, G)[e][t], "{}" === JSON.stringify(Q(this, G)[e]) && delete Q(this, G)[e];
                break
            }
        }

        offKeyEvent(t) {
            (Q(this, U)[t] || []).forEach(e => {
                this.off(t, e)
            }), delete Q(this, U)[t]
        }
    }
    ...
    class Ut {
        constructor(t, e) {
            ...
            }()), q(this, "chatElement"), q(this, "chatEditor"), q(this, "bus"), this.options = Object.assign({}, at, e, {mentionConfig: void 0}), this.deviceInfo.isTablet && (this.deviceInfo.isPc = !1), this.options.device) {
                case"pc":
            ...
            this.bus = new Gt, this.chatElement = new Rt(t, this), this.chatEditor = new jt(this), this.updateConfig(e)
        }

        updateConfig(t) {
            kt(t.placeholder) && this.chatElement.updatePlaceholder(t.placeholder), kt(t.chatStyle) && this.chatElement.updateChatStyle(t.chatStyle), kt(t.maxLength) && (this.options.maxLength = t.maxLength <= 0 ? -1 : t.maxLength, this.bus.emit("ruleMaxLength")), kt(t.keyboardWrapFun) && (this.options.keyboardWrapFun = t.keyboardWrapFun), kt(t.keyboardSendFun) && (this.options.keyboardSendFun = t.keyboardSendFun), kt(t.mentionConfig) && (this.options.mentionConfig = Object.assign({}, this.options.mentionConfig || ot, t.mentionConfig), this.chatElement.createMentionDialog()), kt(t.triggerConfig) && (this.options.triggerConfig = t.triggerConfig.map(t => (t.keyMap || (t.keyMap = ct[t.key] || []), t)), this.chatElement.createTriggerDialog()), kt(t.selectConfig) && (this.options.selectConfig = t.selectConfig, this.chatElement.createSelectDialog()), kt(t.tipConfig) && (this.options.tipConfig = Object.assign({}, ht, t.tipConfig), this.chatElement.createBeforeTip())
        }
        ...
        getHtml(t) {
            ...
            return s.forEach(t => {
                ...
                t.forEach(t => {
                    ...
                    switch (t.type) {
                        case"Mention":
                            n += 'class="chat-tag-mention"', e.saveTagData && (n += ` data-id="${t.id}"`), n += `>@${Ct(t.name)}`;
                            break;
                        case"Trigger":
                            n += 'class="chat-tag-trigger"', e.saveTagData && (n += ` data-id="${t.id}" data-key=${t.key}`), n += `>${t.key}${Ct(t.name)}`;
                            break;
                        case"Select":
                            n += 'class="chat-tag-select"', e.saveTagData && (n += ` data-id="${t.id}" data-key=${t.key}`), n += `>${Ct(t.name)}`;
                            break;
                        case"Input":
                            n += 'class="chat-tag-input"', e.saveTagData && (n += ` data-placeholder="${t.placeholder}" data-key=${t.key}`), n += `>${Ct(t.text || t.placeholder)}`;
                            break;
                        case"Custom":
                            n += 'class="chat-tag-custom"', n += `>${t.html}`;
                            break;
                        case"Write":
                            n += 'class="chat-tag-write"', a = Ct(t.text), e.identifyLink ? n += `>${a.replace(i, t => `<a class="chat-tag-link" href="${t}" target="_blank">${t}</a>`)}` : n += `>${a}`
                    }
                    n += "</span>", s += n
                }), s += "</p>", n += s
            }), n
        ...
        async setHtml(t) {
            await this.chatEditor.insertCustom({html: `<span style="display: inline-block;">${Ot(t)}</span>`})
        }
                ...
                Array.from(t.children, t => {
                    ...
                    switch (i.className) {
                        ...
                        case"chat-tag-mention":
                            e.push({type: "Mention", id: i.dataset.id || "", name: i.textContent});
                            break;
