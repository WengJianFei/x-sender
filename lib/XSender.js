!function (t, e) {
    ...
    var t, e, i, s, n, a, o, c, h, r, l, d, p, g, f, u, m, x, y, w, E, v, b, k, N, C, O, D, T, S, L, $, M, A, W, I, R,
        B, P, H, K, z, _, F, Y, V, j, G, U, Z, X, q, J, Q, tt, et, it, st = Object.defineProperty, nt = t => {
            throw TypeError(t)
    ...
    class Ft {
        constructor(t, e) {
            ht(this, d), at(this, "chatElement"), at(this, "bus"), at(this, "dialog"), at(this, "title", ""), at(this, "key", ""), at(this, "options", []), at(this, "selectNode", null), ht(this, l, []), this.dialog = document.createElement("div"), this.chatElement = t, this.bus = this.chatElement.chat.bus, this.title = e.dialogTitle, this.key = e.key, this.options = e.options, lt(this, d, p).call(this), lt(this, d, g).call(this), lt(this, d, f).call(this)
        }
        ...
        openDialog(t) {
            ...
            if ("Select" === this.selectNode.type) {
                ...
                this.selectNode.$el.children[0].classList.add("active"), Array.from(a, e => {
                    ...
                    s && (h = e.clientHeight, c = !0), s || c || (o += e.clientHeight), Ht(i, s)
                });
    ...
    class ee {
        ...
        async insertTrigger(t) {
            ...
            if (!e) return;
            const {index: i, write: s, grid: n} = e,
                a = new Xt(n, {type: "Trigger", id: t.id, name: t.name, key: t.key, afterElm: s.$el});
            n.children.splice(i + 1, 0, a), await lt(this, I, j).call(this)
        }
        ...
        async insertSelect(t) {
            ...
            if (!e) return;
            const {index: i, write: s, grid: n} = e,
                a = new qt(n, {type: "Select", id: t.id, name: t.name, key: t.key, afterElm: s.$el});
            n.children.splice(i + 1, 0, a), await lt(this, I, j).call(this)
        }
    ...
    class ie {
        constructor() {
            ht(this, Z), ht(this, X), rt(this, Z, Object.create(null)), rt(this, X, Object.create(null))
        }

        on(t, e, i) {
            ct(this, Z)[e] || (ct(this, Z)[e] = Object.create(null)), ct(this, X)[t] || (ct(this, X)[t] = []), ct(this, X)[t].push(e), ct(this, Z)[e][t] = i
        }
        ...
        off(t, e) {
            for (const i in ct(this, Z)[e]) if (i + "" == t + "") {
                delete ct(this, Z)[e][t], "{}" === JSON.stringify(ct(this, Z)[e]) && delete ct(this, Z)[e];
                break
            }
        }

        offKeyEvent(t) {
            (ct(this, X)[t] || []).forEach(e => {
                this.off(t, e)
            }), delete ct(this, X)[t]
        }
    }
    ...
    return at(se, "version", "1.1.7"), at(se, "Component", class extends Ut {
        constructor(t) {
            var e;
            super(t.type, t.context), ht(this, J), at(this, "data", {}), ht(this, q, {}), this.data = t.data || {}, this.$el = document.createElement("span"), this.$el.setAttribute(yt, Dt), this.$el.setAttribute("contenteditable", "false"), this.$el.classList.add("chat-tag-wrap"), this.$el.innerHTML = this.render(), lt(this, J, tt).call(this, this.$el), this.mount({
