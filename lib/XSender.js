!function (t, e) {
    ...
    class Yt {
        ...
        openTip(t) {
            ...
            (this.config.closeNames || []).forEach(t => {
                ...
                Ht(this.dialog), this.tip.classList.add("tip-hover");
                ...
                Ht(this.dialog, !1), this.tip.classList.remove("tip-hover")
            };
    ...
    return at(se, "version", "1.2.1"), at(se, "Component", class extends Ut {
        constructor(t) {
            var e;
