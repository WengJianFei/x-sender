!function (t, e) {
    ...
    var t, e, i, s, n, a, o, c, h, r, l, d, p, g, f, u, m, x, y, E, w, v, b, N, k, O, C, T, D, S, L, M, I, A, $, R, W,
        _, K, P, B, H, V, z, F, Y, j, G, U, X, Z, q, J, Q, tt, et, it, st = Object.defineProperty, nt = t => {
            throw TypeError(t)
    ...
    const pt = '<div class="ant-spin ant-spin-spinning" aria-live="polite" aria-busy="true"><span class="ant-spin-dot ant-spin-dot-spin"><i class="ant-spin-dot-item"></i><i class="ant-spin-dot-item"></i><i class="ant-spin-dot-item"></i><i class="ant-spin-dot-item"></i></span></div>',
        ...
        zt = Symbol("EVENT_DIALOG_KEYBOARD_MOVE"), Ft = "data-set-empty", Yt = "data-set-richType", jt = "richGrid",
        ...
        }, ae = t => null != t, oe = (t, e) => t.replace(/{{(\w+)}}/g, (t, i) => void 0 !== e[i] ? e[i] : t);
        ...
        for (let r = 0; r <= o; r++) for (let t = 0; t <= c; t++) if (h[r][t] && t < c) {
            ...
            for (let i = r; i < o; i++) {
                ...
                if ("char" === e.type) s.char === e.value && (h[i + 1][t + 1] = !0); else {
                    ...
                    if (r === c) h[i + 1][t + 1] = !0; else if (r === a) h[i + 1][t + 1] = !0; else if (de(r, a)) h[i + 1][t + 1] = !0; else for (let e = 2; e <= o - i; e++) {
    ...
    class fe {
        ...
        getRenderMention(t) {
            ...
            e.setAttribute("data-id", t.id), e.setAttribute("data-name", t.name), e.classList.add("chat-mention-dialog-item"), pe(e, !0, "flex");
        ...
        openDialog(t) {
            if (ge(this.dialog) || this.bus.emit(bt), this.asyncMatch) {
                this.options = [], this.updateRender();
                const t = this.dialog.children[2], e = this.dialog.children[3];
                pe(t, !1), pe(e, !0, "flex"), pe(this.dialog), this.moveDialog(), this.bus.emit(It, !0)
                ...
                Array.from(e.children, t => {
                    ...
                    s.includes(e) ? (pe(t, !0, "flex"), i || (i = t)) : pe(t, !1)
                }), this.switchActiveMention(i || e.children[0]), pe(this.dialog), this.moveDialog(), this.bus.emit(It, !0)
            }
        }

        closeDialog() {
            ge(this.dialog) && (pe(this.dialog, !1), this.switchActiveMention(), this.bus.emit(It, !1))
        }
        ...
        pinyinMatchDialog(t) {
            return t ? this.options.filter(e => le(e.name, e.pinyin || "", t)) : this.callEvery ? [{
                id: "ALL",
                name: this.everyText
        ...
        async asyncMatchDialog(t = "") {
            ...
            if (e === this.matchKey) {
                ...
                pe(s, !0, "flex"), t.scrollTop = 0, pe(e, 0 === this.options.length, "flex"), pe(s, !1), this.switchActiveMention(t.children[0]), this.moveDialog()
            }
        }
    ...
    t = new WeakMap, e = new WeakSet, i = function () {
        this.bus.on(this.eventKey, bt, () => {
            ...
            ge(this.dialog) && this.moveDialog()
        ...
        rt(this, t, [[this.chatElement.richText, {
            keydown: t => {
                ge(this.dialog) && (re(t, "dialog-options") ? t.preventDefault() : re(t, "text-move") && this.closeDialog())
            }, keyup: t => {
                if (t.stopPropagation(), "@" === t.key || "2" === String(t.key) || re(t, "IME")) {
            ...
            mousedown: () => {
                ...
                !this.chatElement.chat.chatEditor.isComposition && ge(this.dialog) && re(t, "dialog-options") && (t.preventDefault(), "ArrowUp" === t.key || "ArrowUp" === t.code ? this.bus.emit(zt, "up") : "ArrowDown" === t.key || "ArrowDown" === t.code ? this.bus.emit(zt, "down") : "Enter" !== t.key && "Enter" !== t.code && "NumpadEnter" !== t.code || this.activeMention && this.activeMention.click())
            }
        }]]), ct(this, t).forEach(t => {
            const e = t[0], i = t[1];
        ...
        const s = document.createElement("div");
        s.classList.add("chat-mention-dialog-empty"), pe(s, !1), t.appendChild(s);
        const n = document.createElement("div");
        n.classList.add("chat-mention-dialog-loading"), n.innerHTML = pt, pe(n, !1), t.appendChild(n), this.dialog.appendChild(t), this.chatElement.dialogRoot.appendChild(this.dialog)
    };
    ...
    class ue {
        ...
        openDialog(t) {
            if (ge(this.dialog) || this.bus.emit(bt), this.options.length > 0) {
                const e = this.dialog.children[1];
                let i;
                e.scrollTop = 0;
                const s = (t || this.pinyinMatchDialog()).map(t => t.id);
                Array.from(e.children, t => {
                    const e = t.getAttribute("data-id");
                    s.includes(e) ? (pe(t, !0, "flex"), i || (i = t)) : pe(t, !1)
                }), this.switchActiveTrigger(i || e.children[0]), pe(this.dialog), this.moveDialog(), this.bus.emit(It, !0)
            }
        }

        closeDialog() {
            ge(this.dialog) && (pe(this.dialog, !1), this.switchActiveTrigger(), this.bus.emit(It, !1))
        }
        ...
        pinyinMatchDialog(t) {
            return t ? this.options.filter(e => le(e.name, e.pinyin || "", t)) : this.options
        }
    ...
    a = new WeakMap, o = new WeakSet, c = function () {
        ...
        rt(this, a, [[this.chatElement.richText, {
            keydown: t => {
                ...
                if (t.stopPropagation(), this.keyMap.includes(String(t.key)) || re(t, "IME")) {
                    const t = this.chatElement.chat.getSelection(), e = t.focusNode,
                        i = this.chatElement.chat.chatEditor.findNode(e);
                    if (i && "Write" === i.type) {
                        const e = t.focusOffset;
            ...
            mousedown: () => {
                ...
                !this.chatElement.chat.chatEditor.isComposition && ge(this.dialog) && re(t, "dialog-options") && (t.preventDefault(), "ArrowUp" === t.key || "ArrowUp" === t.code ? this.bus.emit(zt, "up") : "ArrowDown" === t.key || "ArrowDown" === t.code ? this.bus.emit(zt, "down") : "Enter" !== t.key && "Enter" !== t.code && "NumpadEnter" !== t.code || this.activeTrigger && this.activeTrigger.click())
            }
        }]]), ct(this, a).forEach(t => {
            const e = t[0], i = t[1];
            for (const s in i) e.addEventListener(s, i[s])
        ...
        this.options.forEach(t => {
            const e = document.createElement("div");
            e.setAttribute("data-id", t.id), e.setAttribute("data-name", t.name), e.classList.add("chat-trigger-dialog-item"), pe(e, !0, "flex");
            const i = document.createElement("div");
    ...
    class me {
        ...
        openDialog(t) {
            if (ge(this.dialog) || this.bus.emit(bt), this.selectNode = t, !this.selectNode) return;
            if (this.showSearch) {
                const t = this.dialog.children[1];
                t.children[0].value = "", pe(t.children[1], !1)
            }
            pe(this.dialog);
            ...
            if ("Select" === this.selectNode.type) {
                ...
                this.selectNode.$el.children[0].classList.add("active"), Array.from(i, e => {
                    ...
                    c && (a = e.clientHeight, n = !0), c || n || (s += e.clientHeight), pe(i, c)
                });
        ...
        closeDialog() {
            if (ge(this.dialog)) {
                if (pe(this.dialog, !1), this.selectNode && "Select" === this.selectNode.type) {
        ...
        if (i.textContent = this.title, e.appendChild(i), t.appendChild(e), this.showSearch) {
            ...
            i.classList.add("chat-select-dialog-search-input"), i.setAttribute("placeholder", this.placeholder), i.addEventListener("input", se(t => {
                ...
                Array.from(s, t => {
                    ...
                    "" === e || -1 !== i.indexOf(e) ? (n = !1, pe(t, !0, "flex")) : pe(t, !1)
                }), pe(i, n, "flex"), this.moveDialog()
            }, 200).bind(this)), e.appendChild(i);
            const s = document.createElement("div");
            s.classList.add("chat-select-dialog-search-empty"), s.innerHTML = `${gt}<span class="empty-label">${this.searchEmptyText}</span>`, pe(s, !1), e.appendChild(s), t.appendChild(e)
        }
        const s = document.createElement("div");
    ...
    class xe {
        ...
        openTip(t) {
            this.tip.innerHTML = oe(this.tip.innerHTML, t), this.dialog.innerHTML = oe(this.dialog.innerHTML, t), pe(this.tip);
            (this.config.closeNames || []).forEach(t => {
                ...
                pe(this.dialog), this.tip.classList.add("tip-hover");
                ...
                pe(this.dialog, !1), this.tip.classList.remove("tip-hover")
            };
    ...
    u = new WeakMap, m = new WeakSet, x = function () {
        ...
        this.tip.classList.add("chat-before-tip-wrap"), this.dialog.classList.add("chat-tip-dialog-wrap"), this.chatElement.rollBox.appendChild(this.tip), this.chatElement.dialogRoot.appendChild(this.dialog), pe(this.tip, !1), pe(this.dialog, !1)
    }, w = function () {
        if (!ge(this.tip)) return;
    ...
    class ye {
        ...
        createMentionDialog() {
            this.mentionDialog ? this.mentionDialog.updateConfig(this.chat.options.mentionConfig) : this.mentionDialog = new fe(this, this.chat.options.mentionConfig)
        }
        ...
        createTriggerDialog() {
            this.triggerDialogs ? (this.triggerDialogs.forEach(t => {
                ...
                this.triggerDialogs.push(new ue(this, t))
            })
        }
        ...
        createSelectDialog() {
            this.selectDialogs ? (this.selectDialogs.forEach(t => {
                ...
                this.selectDialogs.push(new me(this, t))
            })
        }

        createBeforeTip() {
            this.beforeTip ? this.beforeTip.updateConfig(this.chat.options.tipConfig) : this.beforeTip = new xe(this, this.chat.options.tipConfig)
        }
    ...
    v = new WeakSet, b = function () {
        ...
        this.container.classList.add("chat-area-wrap"), this.rollBox.classList.add("chat-rich-text"), this.rollBox.classList.add("chat-scroll"), this.richText.setAttribute(Yt, "richWrap"), this.richText.setAttribute("contenteditable", "true"), this.rollBox.appendChild(this.richText), this.container.appendChild(this.rollBox)
    }, k = function () {
        this.placeholder.classList.add("chat-placeholder-wrap"), pe(this.placeholder), this.container.appendChild(this.placeholder)
    }, O = function () {
        this.dialogRoot.classList.add("chat-dialog-wrap"), this.container.appendChild(this.dialogRoot)
    }, C = function () {
        if (this.chat.chatEditor.isComposition) return pe(this.placeholder, !1);
        const t = this.chat.chatEditor.NODES;
        return t.length > 1 || t[0].children.length > 1 || t[0].children[0].text.length > 0 ? pe(this.placeholder, !1) : void pe(this.placeholder, !0)
    };
    ...
    let we = class t extends Ee {
        ...
        updateNode() {
            ...
            if (this.text = i.replace(new RegExp(this.VOID_KEY, "ig"), "") || "", t.setAttribute(Ft, String(!Boolean(this.text))), Boolean(this.text)) {
        ...
        render(t) {
            const e = document.createElement("span");
            this.$el = e, e.setAttribute(Yt, Gt), e.classList.add("chat-write-wrap");
            const i = document.createElement("span");
            i.classList.add("chat-write-input"), i.setAttribute(Yt, Ut), i.setAttribute(Ft, String(!Boolean(this.text))), i.appendChild(document.createTextNode(Boolean(this.text) ? this.text : this.VOID_KEY)), e.appendChild(i), this.mount({
    ...
    class be extends ve {
        ...
        render(t) {
            const e = document.createElement("span");
            this.$el = e, e.setAttribute(Yt, Xt), e.setAttribute("contenteditable", "false"), e.classList.add("chat-tag-wrap");
            const i = document.createElement("span");
    ...
    class Ne extends ve {
        ...
        render(t) {
            const e = document.createElement("span");
            this.$el = e, e.setAttribute(Yt, Zt), e.setAttribute("contenteditable", "false"), e.classList.add("chat-tag-wrap");
            const i = document.createElement("span");
    ...
    class ke extends ve {
        ...
        render(t) {
            const e = document.createElement("span");
            this.$el = e, e.setAttribute(Yt, qt), e.setAttribute("contenteditable", "false"), e.classList.add("chat-tag-wrap");
            const i = document.createElement("span");
    ...
    class Oe extends Ee {
        ...
        updateNode() {
            const t = this.$el.children[0].children[0], e = this.$el.children[0].children[1], i = t.childNodes[0],
                s = i.textContent || "";
            if (this.text = s.replace(new RegExp(`${this.WRAP_KEY[0]}|${this.VOID_KEY}`, "ig"), ""), pe(e, !Boolean(this.text), "inline-block"), Boolean(this.text)) {
        ...
        delete(t) {
            ...
            if (t.isCollapsed) if (e + s === this.fixWrapKey(this.text).length || 1 === e && !Boolean(this.text)) if (Boolean(this.text)) {
                ...
                const c = t.slice(0, e - n), h = t.slice(e + a);
        ...
        render(t) {
            const e = document.createElement("span");
            this.$el = e, e.setAttribute(Yt, Jt), e.setAttribute("contenteditable", "false"), e.classList.add("chat-tag-wrap");
            const i = document.createElement("span");
            ...
            n.classList.add("input-tip"), n.textContent = `[${this.placeholder}]`, i.appendChild(n), Boolean(this.text) && pe(n, !1), e.addEventListener("click", () => {
    ...
    class Ce extends ve {
        ...
        render(t) {
            const e = document.createElement("span");
            this.$el = e, e.setAttribute(Yt, Qt), e.setAttribute("contenteditable", "false"), e.classList.add("chat-tag-wrap"), e.innerHTML = this.html, this.mount({
                parentElm: (null == t ? void 0 : t.parentElm) || this.context.$el,
                targetElm: this.$el, ...t || {}
            })
        }
    ...
    class Te extends Ee {
        ...
        splitNode(t, e = 0) {
            ...
            this.children = o;
            const h = new Te(this.context, [], {afterElm: this.$el});
        ...
        splitWriteNode(t, e) {
            ...
            t.text = s, t.syncNode();
            const a = new we(this, {type: "Write", text: n, afterElm: t.$el});
        ...
        render(t, e) {
            ...
            this.$el = i, i.className = "chat-grid-wrap", i.setAttribute(Yt, jt), this.renderChildren(t, !1), this.mount({
        ...
        renderChildren(t, e = !0) {
            ...
            i.forEach(t => {
                ...
                switch (t.type) {
                    case"Write":
                        e = new we(this, {...t, parentElm: s}), this.children.push(e);
                        break;
                    case"Mention":
                        e = new be(this, {...t, parentElm: s}), this.children.push(e);
                        break;
                    case"Trigger":
                        e = new Ne(this, {...t, parentElm: s}), this.children.push(e);
                        break;
                    case"Select":
                        e = new ke(this, {...t, parentElm: s}), this.children.push(e);
                        break;
                    case"Input":
    ...
    class De {
        ...
        initEditor() {
            this.$el.innerHTML = "", this.NODES = [new Te(this)], this.markLastType = "Write", this.NODE_HEIGHT = this.NODES[0].$el.getBoundingClientRect().height, this.undoHistory = [{
        ...
        async fixEditor(t) {
            this.$el.innerHTML = "", t || (t = this.compileNodes(this.NODES)), this.NODES = t.map(t => new Te(this, t)), this.focusLast(), await lt(this, R, j).call(this)
        }
        ...
        findNode(t, e = 5, i = !0) {
            ...
            const s = t, n = s.getAttribute ? s.getAttribute(Yt) : "";
            if (n === Ut) {
        ...
        async insertNodes(t) {
            ...
            t.forEach((e, i) => {
                const s = new Te(this, e, {afterElm: o});
        ...
        async insertMention(t) {
            ...
            const {index: i, write: s, grid: n} = e,
                a = new be(n, {type: "Mention", id: t.id, name: t.name, afterElm: s.$el});
        ...
        async insertTrigger(t) {
            ...
            if (!e) return;
            const {index: i, write: s, grid: n} = e,
                a = new Ne(n, {type: "Trigger", id: t.id, name: t.name, key: t.key, afterElm: s.$el});
            n.children.splice(i + 1, 0, a), await lt(this, R, j).call(this)
        }
        ...
        async insertSelect(t) {
            ...
            if (!e) return;
            const {index: i, write: s, grid: n} = e,
                a = new ke(n, {type: "Select", id: t.id, name: t.name, key: t.key, afterElm: s.$el});
            n.children.splice(i + 1, 0, a), await lt(this, R, j).call(this)
        }
        ...
        async insertInput(t) {
            ...
            if (!e) return;
            const {index: i, write: s, grid: n} = e,
                a = new Oe(n, {type: "Input", text: t.text, placeholder: t.placeholder, key: t.key, afterElm: s.$el});
        ...
        async insertCustom(t) {
            const e = this.splitWrite(t);
            if (!e) return;
            const {index: i, write: s, grid: n} = e, a = new Ce(n, {type: "Custom", html: t.html, afterElm: s.$el});
            n.children.splice(i + 1, 0, a), await lt(this, R, j).call(this)
        }

        async reset(t) {
            if (this.$el.innerHTML = "", this.NODES = t.chatNode.map(t => new Te(this, t)), t.clearHistory) {
                const t = this.NODES[this.NODES.length - 1], e = t.children[t.children.length - 1];
                this.undoHistory = [{
                    nodes: this.compileNodes(this.NODES),
                    gridIndex: this.NODES.length - 1,
    ...
    A = new WeakMap, $ = new WeakMap, R = new WeakSet, W = function () {
        this.bus.on(this.eventKey, kt, async t => {
            ...
            await lt(this, R, F).call(this), t && t()
        ...
        rt(this, $, [[this.$el, {
            keydown: t => {
                if (this.isComposition = t.isComposing, this.chat.deviceInfo.isPc || !re(t, "IME")) {
                    if (!this.IME_MODEL) if (this.isComposition || !re(t, "text-backspace") && !re(t, "text-delete")) if (this.chat.options.keyboardWrapFun(t) || !this.chat.deviceInfo.isPc && "Enter" === t.key) t.preventDefault(), t.stopPropagation(), lt(this, R, P).call(this); else if (!ct(this, A) && this.chat.options.keyboardSendFun(t)) t.preventDefault(), t.stopPropagation(), this.isComposition || this.bus.emit(yt); else if (re(t, "text-select-all")) t.preventDefault(), t.stopPropagation(), this.selectAll(); else if (re(t, "text-move")) t.preventDefault(), t.stopPropagation(), this.isComposition || this.cursorMove("ArrowLeft" === t.key || "ArrowLeft" === t.code ? -1 : 1); else if (re(t, "text-updown")) {
                    ...
                    } else re(t, "text-undo") ? (t.preventDefault(), t.stopPropagation(), lt(this, R, z).call(this)) : re(t, "text-redo") ? (t.preventDefault(), t.stopPropagation(), lt(this, R, F).call(this)) : re(t, "text-jump") && (t.preventDefault(), t.stopPropagation(), t.shiftKey ? this.chat.jumpPrev() : this.chat.jumpNext()); else {
                        t.preventDefault(), t.stopPropagation();
                        const e = re(t, "text-delete");
                ...
                this.chat.nextTick(async () => {
                    this.$el.innerHTML = "", this.NODES = c.map(t => new Te(this, t));
            ...
            keydown: t => {
                (re(t, "text-undo") || re(t, "text-redo")) && (t.preventDefault(), t.stopPropagation())
            }
        }]]);
        const t = ["blur"];
        ct(this, $).forEach(e => {
        ...
        this.redoHistory.push(t), this.undoHistory.pop(), await lt(this, R, Y).call(this, e)
    }, F = async function () {
        if (this.historyLoading || this.redoHistory.length <= 0) return;
        const t = this.redoHistory[this.redoHistory.length - 1];
        this.redoHistory.pop(), this.undoHistory.push(t), await lt(this, R, Y).call(this, t)
    }, Y = async function (t) {
        this.historyLoading = !0, this.$el.innerHTML = "", this.NODES = t.nodes.map(t => new Te(this, t));
    ...
    class Le {
        constructor(t, e) {
            ...
            this.bus = new Se, this.chatElement = new ye(t, this), this.chatEditor = new De(this), this.updateConfig(e)
        }
        ...
        getHtml(t) {
            ...
            return s.forEach((t, s) => {
                ...
                t.forEach((t, n) => {
                    ...
                    switch (t.type) {
                        case"Mention":
                            c += 'class="chat-tag-mention"', e.saveTagData && (c += ` data-id="${t.id}"`), c += `>@${ce(t.name)}`;
                            break;
                        case"Trigger":
                            c += 'class="chat-tag-trigger"', e.saveTagData && (c += ` data-id="${t.id}" data-key=${t.key}`), c += `>${t.key}${ce(t.name)}`;
                            break;
                        case"Select":
                            c += 'class="chat-tag-select"', e.saveTagData && (c += ` data-id="${t.id}" data-key=${t.key}`), c += `>${ce(t.name)}`;
                            break;
                        case"Input":
                            c += 'class="chat-tag-input"', e.saveTagData && (c += ` data-placeholder="${t.placeholder}" data-key=${t.key}`), c += `>${ce(t.text || t.placeholder)}`;
                            break;
                        case"Custom":
                            c += 'class="chat-tag-custom"', c += `>${t.html}`;
                            break;
                        case"Write":
                            c += 'class="chat-tag-write"', a = ce(t.text), e.identifyLink ? c += `>${a.replace(i, t => `<a class="chat-tag-link" href="${t}" target="_blank">${t}</a>`)}` : c += `>${a}`;
                            break;
                        default:
        ...
        async setHtml(t) {
            return new Promise(e => {
                this.bus.emit(_t, {html: `<span style="display: inline-block;">${he(t)}</span>`}, e)
            })
        }
    ...
    return at(Le, "version", "1.3.1"), at(Le, "EventSet", {
    ...
    }), at(Le, "Component", class extends ve {
        constructor(t) {
            var e;
            super(t.type, t.context), ht(this, J), at(this, "data", {}), ht(this, q, {}), this.data = t.data || {}, this.$el = document.createElement("span"), this.$el.setAttribute(Yt, te), this.$el.setAttribute("contenteditable", "false"), this.$el.classList.add("chat-tag-wrap"), this.$el.innerHTML = this.render(), lt(this, J, tt).call(this, this.$el), this.mount({
