!function (t, e) {
    ...
    "use strict";
    var t, e, i, s, n, a, o, c, h, r, l, d, p, g, f, u, m, x, y, w, E, b, v, k, N, C, O, D, T, S, L, $, M, A, W, I, R,
        B, P, H, K, z, _, F, Y, V, j, G, U, Z, q, X, J, Q, tt, et, it, st = Object.defineProperty, nt = t => {
            throw TypeError(t)
    ...
    const pt = '<div class="ant-spin ant-spin-spinning" aria-live="polite" aria-busy="true"><span class="ant-spin-dot ant-spin-dot-spin"><i class="ant-spin-dot-item"></i><i class="ant-spin-dot-item"></i><i class="ant-spin-dot-item"></i><i class="ant-spin-dot-item"></i></span></div>',
        ...
        }, xt = "data-set-empty", yt = "data-set-richType", wt = "richGrid", Et = "richMark", bt = "richWrite",
        vt = "richMention", kt = "richTrigger", Nt = "richSelect", Ct = "richInput", Ot = "richCustom",
        ...
        for (let r = 0; r <= o; r++) for (let t = 0; t <= c; t++) if (h[r][t] && t < c) {
            ...
            for (let i = r; i < o; i++) {
                ...
                if ("char" === e.type) s.char === e.value && (h[i + 1][t + 1] = !0); else {
                    ...
                    if (r === c) h[i + 1][t + 1] = !0; else if (r === a) h[i + 1][t + 1] = !0; else if (Pt(r, a)) h[i + 1][t + 1] = !0; else for (let e = 2; e <= o - i; e++) {
    ...
    class zt {
        ...
        getRenderMention(t) {
            ...
            e.setAttribute("data-id", t.id), e.setAttribute("data-name", t.name), e.classList.add("chat-mention-dialog-item"), Ht(e, !0, "flex");
        ...
        openDialog(t) {
            if (Kt(this.dialog) || this.bus.emit("closeDialog"), this.asyncMatch) {
                ...
                Ht(t, !1), Ht(e, !0, "flex"), Ht(this.dialog), this.moveDialog(), this.bus.emit("switchDisabledState", !0)
                ...
                Array.from(e.children, t => {
                    ...
                    s.includes(e) ? (Ht(t, !0, "flex"), i || (i = t)) : Ht(t, !1)
                }), this.switchActiveMention(i || e.children[0]), Ht(this.dialog), this.moveDialog(), this.bus.emit("switchDisabledState", !0)
            }
        }

        closeDialog() {
            Kt(this.dialog) && (Ht(this.dialog, !1), this.switchActiveMention(), this.bus.emit("switchDisabledState", !1))
        }
        ...
        async asyncMatchDialog(t = "") {
            ...
            if (e === this.matchKey) {
                ...
                Ht(s, !0, "flex"), t.scrollTop = 0, Ht(e, 0 === this.options.length, "flex"), Ht(s, !1), this.switchActiveMention(t.children[0])
            }
        }
    ...
    t = new WeakMap, e = new WeakSet, i = function () {
        ...
        this.dialog.classList.add("chat-mention-dialog-wrap"), Ht(this.dialog, !1);
        ...
        const s = document.createElement("div");
        s.classList.add("chat-mention-dialog-empty"), Ht(s, !1), t.appendChild(s);
        const n = document.createElement("div");
        n.classList.add("chat-mention-dialog-loading"), n.innerHTML = pt, Ht(n, !1), t.appendChild(n), this.dialog.appendChild(t), this.chatElement.dialogRoot.appendChild(this.dialog)
    };
        ...
        openDialog(t) {
            if (Kt(this.dialog) || this.bus.emit("closeDialog"), this.options.length > 0) {
                ...
                Array.from(e.children, t => {
                    const e = t.getAttribute("data-id");
                    s.includes(e) ? (Ht(t, !0, "flex"), i || (i = t)) : Ht(t, !1)
                }), this.switchActiveTrigger(i || e.children[0]), Ht(this.dialog), this.moveDialog(), this.bus.emit("switchDisabledState", !0)
            }
        }

        closeDialog() {
            Kt(this.dialog) && (Ht(this.dialog, !1), this.switchActiveTrigger(), this.bus.emit("switchDisabledState", !1))
        }
    ...
    a = new WeakMap, o = new WeakSet, c = function () {
        ...
        this.dialog.classList.add("chat-trigger-dialog-wrap"), Ht(this.dialog, !1);
        const t = document.createDocumentFragment(), e = document.createElement("div");
        ...
        this.options.forEach(t => {
            const e = document.createElement("div");
            e.setAttribute("data-id", t.id), e.setAttribute("data-name", t.name), e.classList.add("chat-trigger-dialog-item"), Ht(e, !0, "flex");
            const i = document.createElement("div");
    ...
    class Ft {
        ...
        openDialog(t) {
            ...
            if ("Select" === this.selectNode.type) {
                ...
                this.selectNode.$el.children[0].classList.add("active"), Array.from(a, i => {
                    ...
                    n && (h = i.clientHeight, c = !0), n || c || (o += i.clientHeight), Ht(s, n)
                });
        ...
        closeDialog() {
            if (Kt(this.dialog)) {
                if (Ht(this.dialog, !1), this.selectNode && "Select" === this.selectNode.type) {
    ...
    l = new WeakMap, d = new WeakSet, p = function () {
        ...
        this.dialog.classList.add("chat-select-dialog-wrap"), Ht(this.dialog, !1);
        const t = document.createDocumentFragment(), e = document.createElement("div");
    ...
    class Yt {
        ...
        openTip(t) {
            this.tip.innerHTML = At(this.tip.innerHTML, t), this.dialog.innerHTML = At(this.dialog.innerHTML, t), Ht(this.tip);
    ...
    u = new WeakMap, m = new WeakSet, x = function () {
        ...
        this.tip.classList.add("chat-before-tip-wrap"), this.dialog.classList.add("chat-tip-dialog-wrap"), this.chatElement.rollBox.appendChild(this.tip), this.chatElement.dialogRoot.appendChild(this.dialog), Ht(this.tip, !1), Ht(this.dialog, !1)
    }, E = function () {
    ...
    class Vt {
        constructor(t, e) {
            ht(this, b), at(this, "chat"), at(this, "container"), at(this, "rollBox"), at(this, "richText"), at(this, "placeholder"), at(this, "dialogRoot"), at(this, "mentionDialog"), at(this, "triggerDialogs"), at(this, "selectDialogs"), at(this, "beforeTip"), this.chat = e, this.container = t, this.rollBox = document.createElement("div"), this.richText = document.createElement("div"), this.placeholder = document.createElement("div"), this.dialogRoot = document.createElement("div"), lt(this, b, v).call(this), lt(this, b, k).call(this), lt(this, b, N).call(this), lt(this, b, C).call(this)
        }
    ...
    b = new WeakSet, v = function () {
        ...
        this.placeholder.classList.add("chat-placeholder-wrap"), Ht(this.placeholder), this.container.appendChild(this.placeholder)
    }, C = function () {
        this.dialogRoot.classList.add("chat-dialog-wrap"), this.container.appendChild(this.dialogRoot)
    }, O = function () {
        if (this.chat.chatEditor.isComposition) return Ht(this.placeholder, !1);
        const t = this.chat.chatEditor.NODES;
        return t.length > 1 || t[0].children.length > 1 || t[0].children[0].text.length > 0 ? Ht(this.placeholder, !1) : void Ht(this.placeholder, !0)
    };
    ...
    let Gt = class t extends jt {
        ...
        render(t) {
            ...
            const i = document.createElement("span");
            i.classList.add("chat-write-input"), i.setAttribute(yt, bt), i.setAttribute(xt, String(!Boolean(this.text))), i.appendChild(document.createTextNode(Boolean(this.text) ? this.text : this.VOID_KEY)), e.appendChild(i), this.mount({
    ...
    class Zt extends Ut {
        ...
        render(t) {
            const e = document.createElement("span");
            this.$el = e, e.setAttribute(yt, vt), e.setAttribute("contenteditable", "false"), e.classList.add("chat-tag-wrap");
            const i = document.createElement("span");
    ...
    class Jt extends jt {
        ...
        updateNode() {
            const t = this.$el.children[0].children[0], e = this.$el.children[0].children[1], i = t.childNodes[0],
                s = i.textContent || "";
            if (this.text = s.replace(new RegExp(`${this.WRAP_KEY[0]}|${this.VOID_KEY}`, "ig"), ""), Ht(e, !Boolean(this.text), "inline-block"), Boolean(this.text)) {
        ...
        render(t) {
            ...
            n.classList.add("input-tip"), n.textContent = `[${this.placeholder}]`, i.appendChild(n), Boolean(this.text) && Ht(n, !1), e.addEventListener("click", () => {
    ...
    class ee {
        ...
        findNode(t, e = 5, i = !0) {
            ...
            if (n === vt || n === kt || n === Nt || n === Ct || n === Ot || n === Dt) {
                const t = s, e = t.parentElement, i = Array.prototype.indexOf.call(e.children, t),
                    n = Array.prototype.indexOf.call(this.$el.children, e);
                return this.NODES[n].children[i]
            }
    ...
    A = new WeakMap, W = new WeakMap, I = new WeakSet, R = function () {
        ...
        rt(this, W, [[this.$el, {
            keydown: t => {
                if (this.isComposition = t.isComposing, this.chat.deviceInfo.isPc || !Rt(t, "IME")) {
                    if (!this.IME_MODEL) if (this.isComposition || !Rt(t, "text-backspace") && !Rt(t, "text-delete")) this.chat.options.keyboardWrapFun(t) || !this.chat.deviceInfo.isPc && "Enter" === t.key ? (t.preventDefault(), t.stopPropagation(), lt(this, I, H).call(this)) : !ct(this, A) && this.chat.options.keyboardSendFun(t) ? (t.preventDefault(), t.stopPropagation(), this.isComposition || this.bus.emit("send")) : Rt(t, "text-select-all") ? (t.preventDefault(), t.stopPropagation(), this.selectAll()) : Rt(t, "text-move") ? (t.preventDefault(), t.stopPropagation(), this.isComposition || this.cursorMove("ArrowLeft" === t.key || "ArrowLeft" === t.code ? -1 : 1)) : Rt(t, "text-undo") ? (t.preventDefault(), t.stopPropagation(), lt(this, I, F).call(this)) : Rt(t, "text-redo") && (t.preventDefault(), t.stopPropagation(), lt(this, I, Y).call(this)); else {
                ...
                this.chat.nextTick(async () => {
                    ...
                    this.NODES[a].children[o].focus(s), "insertParagraph" === t.inputType ? await lt(this, I, H).call(this) : "deleteContentBackward" === t.inputType && await lt(this, I, P).call(this), this.IME_MODEL = !1, this.FIX_MODEL = !1
                })
            }, input: () => {
        ...
        let f, u, m, x, y, w, E, b;
        p > g ? (f = d, u = l, m = a, x = n, y = g, w = p, E = c, b = o) : (f = l, u = d, m = n, x = a, y = p, w = g, E = o, b = c);
        const v = f.children.indexOf(m),
            k = this.compileNodes([{type: "Gird", children: f.children.filter((t, e) => e > v)}]);
        ...
        this.chat.getSelection().isCollapsed || await lt(this, I, P).call(this), n && n.length > 0 ? this.insertNodes(n) : this.insertText(i)
    }, _ = function () {
        ...
        return s && lt(this, I, G).call(this, {
            ...
            instance: s
        }), await this.chat.nextTick(), this.isComposition || (null == s || s.updateNode(), lt(this, I, U).call(this), this.chat.deviceInfo.isPc && t && !this.historyLoading && this.bus.emit("recordHistory")), s && this.cursorView(), this.bus.emit("editorChange"), !this.isComposition && this.chat.deviceInfo.isPc && s && "Write" === s.type && this.bus.emit("matchDialog"), !0
    }, G = function (t) {
        if (!t) {
            const e = this.chat.getSelection(), i = e.focusNode, s = this.findNode(i);
            if (!s) return;
    ...
    return at(se, "version", "1.2.0"), at(se, "Component", class extends Ut {
        constructor(t) {
            var e;
